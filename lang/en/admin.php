...
return [
    ...
    */
    'students' => [
        ...
        'finance' => [
            ...
            'load_error' => 'Failed to load financial data. Please try again.',
            ...
            'empty' => [
                'ledger' => 'No transactions recorded yet.',
                'invoices' => 'No invoices found for this student.',
                'receipts' => 'No receipts found for this student.',
                'discounts' => 'No discounts applied for this student.',
    ...
    */
    ...
    'academic_years' => [
        ...
        'subtitle' => 'Academic Years Management',
        'description' => 'Create and manage school years timeline and current year state.',
        'add' => 'Add Academic Year',
        'edit' => 'Edit Academic Year',
        'show' => 'Academic Year Details',
        'year_details' => 'Timeline and current-year configuration',
        'count' => ':count years',
        ...
        'messages' => [
            ...
            'failed' => [
                'add' => 'Failed to add academic year.',
                'update' => 'Failed to update academic year.',
    ...
    'finance' => [
        'messages' => [
            'success' => [
                ...
                'payment_gateway_activated' => 'Payment gateway activated successfully.',
                'payment_gateway_enabled' => 'Payment gateway enabled successfully.',
                'payment_gateway_disabled' => 'Payment gateway disabled successfully.',
                'payment_voucher_created' => 'Payment voucher created successfully.',
                'payment_voucher_deleted' => 'Payment voucher deleted successfully.',
                'student_discount_created' => 'Student discount created successfully.',
                'student_discount_deleted' => 'Student discount deleted successfully.',
            ],
            'failed' => [
                ...
                'online_gateway_not_allowed' => 'Online payment gateways are not allowed for manual entries.',
                ...
                'payment_gateway_created' => 'Failed to create payment gateway.',
                'payment_gateway_updated' => 'Failed to update payment gateway.',
                'payment_gateway_deleted' => 'Failed to delete payment gateway.',
                'payment_gateway_in_use' => 'Cannot delete this payment gateway — it is used in existing receipts. Disable it instead.',
                'payment_processing_failed' => 'Payment processing failed. Please try again.',
                'bank_transfer_ref_required' => 'Bank transfer reference number is required.',
                'payment_voucher_created' => 'Failed to create payment voucher.',
                'payment_voucher_delete' => 'Failed to delete payment voucher.',
                'payment_voucher_deleted' => 'Failed to delete payment voucher.',
                'student_discount_created' => 'Failed to create student discount.',
                'student_discount_delete' => 'Failed to delete student discount.',
            ],
        ],
        ...
        'receipts' => [
            ...
            'print_receipt_details' => 'Receipt Details',
            'print_receipt_no' => 'Receipt #',
            'print_exchange_rate' => 'Exchange Rate',
            'print_footer_note' => 'This is an official payment receipt. Keep for your records.',
            'print_official' => 'Official Receipt',
            'fields' => [
                'student' => 'Student',
        ...
        'payment_gateways' => [
            ...
            'subtitle' => 'Configure and manage your payment processors',
            ...
            'no_settings' => 'No settings required',
            'type_online' => 'Online',
            'type_offline' => 'Offline',
            'type_unlinked' => 'Unlinked',
            'gateway_count' => ':count gateway|:count gateways',
            'fields' => [
                'code' => 'Gateway Code',
                'name' => 'Gateway Name',
                'name_ar' => 'Gateway Name (Arabic)',
                'name_en' => 'Gateway Name (English)',
        ...
        'payment_vouchers' => [
            ...
            'management' => 'Payment Vouchers Management',
        ...
        'student_discounts' => [
            ...
            'management' => 'Student Discounts Management',
    ...
    */
    ...
    'exports' => [
        ...
        'attendance_report_pdf' => [
            ...
            'modal_title' => 'Export Attendance Report (PDF)',
            'modal_description' => 'Select the filters below to customize your PDF export. Leave grade and section empty to export all data.',
        ...
        'grades_report' => [
            'title' => 'Grades Report',
            'subtitle' => 'Detailed grades export for student exam results',
            'sheet_title' => 'Grades Report',
            'ready_message' => 'Your grades report is ready for download. Click here!',
            'generate_report_message' => 'Your Excel export is being generated. You will receive a notification when it\'s ready.',
            'export_button' => 'Export Excel',
            'modal_title' => 'Export Grades Report',
            'modal_description' => 'Select the filters below to customize your export. Leave fields empty to export all data.',
            'generate_button' => 'Generate Export',
            'generated_on' => 'Generated On',
            'info_message' => 'The export will be processed in the background. You\'ll receive a notification when it\'s ready.',
            'student_name' => 'Student Name',
        ...
        'grades_report_pdf' => [
            'title' => 'Grades Report (PDF)',
            'export_button' => 'Export PDF',
            'modal_title' => 'Export Grades Report (PDF)',
            'modal_description' => 'Select the filters below to customize your PDF export. Leave fields empty to export all data with charts.',
            'generate_button' => 'Generate PDF',
            'info_message' => 'The PDF export will be processed in the background. You\'ll receive a notification when it\'s ready.',
            'ready_message' => 'Your PDF grades report is ready for download. Click here!',
            'generate_report_message' => 'Your PDF export is being generated. You will receive a notification when it\'s ready.',
        ],
        'errors' => [
    ...
    */
    'dashboard' => [
        ...
        'this_month' => 'this month',
        'monthly_enrollment' => 'Monthly Enrollment Trend',
        'enrollment_subtitle' => 'New students enrolled per month (last 12 months)',
        'new_students' => 'New Students',
        'attendance_overview' => 'Attendance Overview',
        'attendance_subtitle' => 'This month\'s attendance distribution',
        'present' => 'Present',
        'absent' => 'Absent',
        'late' => 'Late',
        'total_records' => 'Total',
        'no_data' => 'No Data',
        'revenue_vs_invoices' => 'Revenue vs Invoices',
        'revenue_subtitle' => 'Monthly comparison for the current academic year',
        'collected' => 'Collected',
        'invoiced' => 'Invoiced',
        'students_per_grade' => 'Students per Grade',
        'grade_subtitle' => 'Active student distribution across grades',
        'students' => 'Students',
        'recent_invoices' => 'Recent Invoices',
        'invoices_subtitle' => 'Last 5 invoices issued',
        'student_name' => 'Student',
        'fee_type' => 'Fee Type',
        'amount' => 'Amount',
        'date' => 'Date',
        'no_invoices' => 'No invoices found.',
        'upcoming_classes' => 'Upcoming Online Classes',
        'classes_subtitle' => 'Next scheduled online sessions',
        ...
        'performance_subtitle' => 'Key performance indicators at a glance',
        ...
        'activity_subtitle' => 'Latest updates across the school',
