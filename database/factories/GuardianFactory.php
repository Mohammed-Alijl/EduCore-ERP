...
class GuardianFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'nationality_father_id' => \App\Models\Nationality::inRandomOrder()->value('id') ?? 1,
            'blood_type_father_id' => \App\Models\TypeBlood::inRandomOrder()->value('id') ?? 1,
            'religion_father_id' => \App\Models\Religion::inRandomOrder()->value('id') ?? 1,
            ...
            'nationality_mother_id' => \App\Models\Nationality::inRandomOrder()->value('id') ?? 1,
            'blood_type_mother_id' => \App\Models\TypeBlood::inRandomOrder()->value('id') ?? 1,
            'religion_mother_id' => \App\Models\Religion::inRandomOrder()->value('id') ?? 1,
