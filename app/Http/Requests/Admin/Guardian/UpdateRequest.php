    ...
    public function rules(): array
    {
        ...
        return [
            'email' => [
                ...
                Rule::unique('guardians', 'email')->ignore($guardianId),
            ],
            ...
            'national_id_father' => [
                'required', 'string', 'min:9', 'max:10',
                Rule::unique('guardians', 'national_id_father')->ignore($guardianId),
            ],
            ...
            'national_id_mother' => [
                'nullable', 'string', 'min:9', 'max:10',
                Rule::unique('guardians', 'national_id_mother')->ignore($guardianId),
            ],
