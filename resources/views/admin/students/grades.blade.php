...
@section('title', trans('admin.students.grades.title') . ' - ' . $student['name'])
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="content-title mb-0 my-auto font-weight-bold">{{ trans('admin.students.grades.title') }}</h4>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div class="mb-3 mb-xl-0 ml-2">
                <a class="btn btn-modern btn-outline-secondary" href="{{ route('admin.students.index') }}">
    ...
    <div class="grades-report-container">
        <div class="grades-header-card">
            ...
            <div class="grades-year-selector">
                <label class="grades-year-label">{{ trans('admin.students.grades.academic_year') }}</label>
            ...
            <div class="grades-summary-grid">
                <div class="grades-summary-card grades-card-overall {{ $summary['overall_color'] }}">
                    ...
                    <div class="grades-summary-content">
                        <span class="grades-summary-label">{{ trans('admin.students.grades.overall_grade') }}</span>
                        ...
                        <span class="grades-summary-percentage">
                            ...
                            @else
                                {{ trans('admin.students.grades.no_exams') }}
                            @endif
                        </span>
                    </div>
                </div>
                ...
                <div class="grades-summary-card grades-card-subjects">
                    ...
                    <div class="grades-summary-content">
                        <span class="grades-summary-label">{{ trans('admin.students.grades.subjects') }}</span>
                        <span
                            class="grades-summary-value">{{ $summary['subjects_with_exams'] }}/{{ $summary['total_subjects'] }}</span>
                        <span class="grades-summary-hint">{{ trans('admin.students.grades.with_exams') }}</span>
                    </div>
                </div>
                ...
                <div class="grades-summary-card grades-card-exams">
                    ...
                    <div class="grades-summary-content">
                        <span class="grades-summary-label">{{ trans('admin.students.grades.total_exams') }}</span>
                        <span class="grades-summary-value">{{ $summary['total_exams'] }}</span>
                        <span class="grades-summary-hint">{{ trans('admin.students.grades.completed') }}</span>
                    </div>
                </div>
                ...
                <div class="grades-summary-card grades-card-score">
                    ...
                    <div class="grades-summary-content">
                        <span class="grades-summary-label">{{ trans('admin.students.grades.total_score') }}</span>
                        <span
                            class="grades-summary-value">{{ $summary['overall_score'] }}/{{ $summary['overall_marks'] }}</span>
                        <span class="grades-summary-hint">{{ trans('admin.students.grades.points') }}</span>
                    </div>
                </div>
            </div>
            ...
            @if ($summary['subjects_with_exams'] > 0)
                <div class="grades-distribution-card">
                    <h5 class="grades-distribution-title">
                        ...
                        {{ trans('admin.students.grades.grade_distribution') }}
                    </h5>
        ...
        <div class="grades-subjects-section">
            <h4 class="grades-section-title">
                ...
                {{ trans('admin.students.grades.subjects_breakdown') }}
            </h4>
            ...
            @if ($subjects->isEmpty())
                <div class="grades-empty-state">
                    ...
                    <p class="grades-empty-message">{{ trans('admin.students.grades.no_subjects') }}</p>
                </div>
            @else
                        ...
                        <div class="grades-subject-card {{ $subject['exam_count'] > 0 ? 'has-exams' : 'no-exams' }}">
                            <div class="grades-subject-header">
                                <div class="grades-subject-info">
                                    ...
                                    <span class="grades-exam-count">
                                        {{ $subject['exam_count'] }} {{ trans('admin.students.grades.exams') }}
                                    </span>
                                </div>
                            ...
                            @else
                                <div class="grades-no-exams-message">
                                    ...
                                    {{ trans('admin.students.grades.no_exams_for_subject') }}
                                </div>
                            @endif
                        </div>
                    @endforeach
    ...
    <script>
        $(document).ready(function() {
            $('#academic_year_select').on('change', function() {
                var yearId = $(this).val();
                var url = "{{ route('admin.students.grades', $student['id']) }}";
