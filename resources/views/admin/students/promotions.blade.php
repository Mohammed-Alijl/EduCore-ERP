...
@section('css')
    ...
    <link href="{{ URL::asset('assets/admin/css/student/promotion.css') }}" rel="stylesheet">
                    ...
                    <form method="GET" action="{{ route('admin.students.promotions.index') }}">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{ trans('admin.promotions.fields.from_grade') }} <span
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{ trans('admin.promotions.fields.from_classroom') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{ trans('admin.promotions.fields.from_section') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{ trans('admin.promotions.fields.from_academic_year') }} <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary">
                                ...
                                {{ trans('admin.promotions.load_students') }}
                            </button>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="summary-card">
                        <div class="summary-item">
                            ...
                            <div>
                                <div class="text-white-50" style="font-size: 12px;">
                                    {{ trans('admin.promotions.fields.promote') }}</div>
                        ...
                        @can('graduate_students')
                            <div class="summary-item">
                                ...
                                <div>
                                    <div class="text-white-50" style="font-size: 12px;">
                                        {{ trans('admin.promotions.fields.graduate') }}</div>
                        ...
                        <div class="summary-item">
                            ...
                            <div>
                                <div class="text-white-50" style="font-size: 12px;">
                                    {{ trans('admin.promotions.repeat_hint') }}</div>
                        ...
                        @can('graduate_students')
                            <div class="mode-selector">
                                <button type="button" class="mode-btn active" data-mode="promote">
                                    <i class="fas fa-arrow-up"></i>
                                    <span>{{ trans('admin.promotions.fields.promote') }}</span>
                                </button>
                                <button type="button" class="mode-btn graduate" data-mode="graduate">
                                    <i class="fas fa-graduation-cap"></i>
                                    <span>{{ trans('admin.promotions.fields.graduate') }}</span>
                                </button>
                            </div>
                        @endcan
                    </div>
                        ...
                        @if ($students->count())
                            <div class="graduate-mode-info">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <strong>{{ trans('admin.promotions.graduation_mode') }}</strong>
                                        <p class="mb-0 mt-1">{{ trans('admin.promotions.graduation_mode_hint') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form id="promotion-form" data-parsley-validate="">
                                ...
                                <div class="row destination-fields">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{ trans('admin.promotions.fields.to_grade') }} <span
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{ trans('admin.promotions.fields.to_classroom') }} <span
                                                    class="text-danger destination-required">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{ trans('admin.promotions.fields.to_section') }} <span
                                                    class="text-danger destination-required">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{ trans('admin.promotions.fields.to_academic_year') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-10p border-bottom-0">
                                                    {{ trans('admin.students.fields.student_code') }}</th>
                                                <th class="wd-20p border-bottom-0">
                                                    {{ trans('admin.students.fields.name') }}</th>
                                                <th class="wd-20p border-bottom-0">
                                                    {{ trans('admin.students.fields.guardian') }}</th>
                                                <th class="wd-10p border-bottom-0">
                                                    {{ trans('admin.students.fields.grade') }}</th>
                                                <th class="wd-10p border-bottom-0">
                                                    {{ trans('admin.students.fields.classroom') }}</th>
                                                <th class="wd-10p border-bottom-0">
                                                    {{ trans('admin.students.fields.section') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div class="d-flex justify-content-end mt-3">
                                    <button type="button" id="submit-promotion" class="btn btn-success btn-lg">
                                        ...
                                        <span id="submit-btn-text">{{ trans('admin.promotions.promote') }}</span>
                                    </button>
                                </div>
                            </form>
                        @else
                            <div class="alert alert-info mb-0">
                                ...
                                {{ trans('admin.promotions.no_students') }}
                            </div>
                        @endif
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $('.mode-btn').on('click', function() {
                ...
                if (mode === 'promote') {
                    ...
                    $('#submit-btn-text').text('{{ trans('admin.promotions.promote') }}');
                } else {
                    ...
                    $('#submit-btn-text').text('{{ trans('admin.promotions.fields.graduate') }}');
                }
            ...
            $('#submit-promotion').on('click', function() {
                ...
                if (currentMode === 'promote') {
                    if (!$('#to_grade_id').val() || !$('#to_classroom_id').val() ||
                        ...
                        Swal.fire({
                            ...
                            text: '{{ trans('admin.promotions.select_destination') }}',
                            icon: 'warning',
                ...
                if (promotedCount === 0 && graduatedCount === 0) {
                    Swal.fire({
                        title: '{{ trans('admin.global.validation_error') }}',
                        text: '{{ trans('admin.promotions.select_students') }}',
                        icon: 'warning',
                        confirmButtonColor: '#d33',
                    });
                    return;
                ...
                if (promotedCount > 0) {
                    summaryLines.push(
                        `<div class="d-flex align-items-center gap-2 mb-2"><i class="fas fa-arrow-up text-primary"></i> <strong>{{ trans('admin.promotions.fields.promote') }}:</strong> ${promotedCount} {{ trans('admin.promotions.students') }}</div>`
                        );
                }
                if (graduatedCount > 0) {
                    summaryLines.push(
                        `<div class="d-flex align-items-center gap-2 mb-2"><i class="fas fa-graduation-cap text-danger"></i> <strong>{{ trans('admin.promotions.fields.graduate') }}:</strong> ${graduatedCount} {{ trans('admin.promotions.students') }}</div>`
                        );
                }
                ...
                @if ($students)
                    ...
                    if (repeatCount > 0) {
                        summaryLines.push(
                            `<div class="d-flex align-items-center gap-2"><i class="fas fa-redo text-warning"></i> <strong>{{ trans('admin.promotions.repeat_hint') }}:</strong> ${repeatCount} {{ trans('admin.promotions.students') }}</div>`
                            );
                    }
                @endif
