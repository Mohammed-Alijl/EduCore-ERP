        ...
        <div class="d-flex my-xl-auto right-content align-items-center">
            @can('view-archived_students')
                <div class="mb-3 mb-xl-0 ml-2">
                    <a class="btn btn-modern btn-danger shadow-sm" href="{{ route('admin.students.archived') }}">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-10p border-bottom-0 text-center">
                                        {{ trans('admin.students.fields.status') }}</th>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.finance-btn', function(e) {
                ...
                <div class="modal-body text-center py-5">
                    ...
                    <p class="mt-3 text-muted">{{ trans('admin.students.finance.loading') }}</p>
                </div>
            `);
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        <div class="modal-body text-center py-5">
                            ...
                            <p class="text-muted">{{ trans('admin.students.finance.load_error') }}</p>
