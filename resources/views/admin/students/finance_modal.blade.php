...
<div class="modal-body finance-modal-body p-4">
    ...
    <div class="finance-summary-grid mb-4">
        ...
        <div class="finance-summary-card finance-card-invoiced">
            ...
            <div class="finance-card-content">
                <span class="finance-card-label">{{ trans('admin.students.finance.total_invoiced') }}</span>
                <span class="finance-card-value">{{ $summary['total_invoiced'] }}</span>
                <span class="finance-card-count">{{ $summary['invoice_count'] }}
                    {{ trans('admin.students.finance.invoices') }}</span>
            </div>
        </div>
        ...
        <div class="finance-summary-card finance-card-paid">
            ...
            <div class="finance-card-content">
                <span class="finance-card-label">{{ trans('admin.students.finance.total_paid') }}</span>
                <span class="finance-card-value">{{ $summary['total_paid'] }}</span>
                <span class="finance-card-count">{{ $summary['receipt_count'] }}
                    {{ trans('admin.students.finance.receipts') }}</span>
            </div>
        </div>
        ...
        <div class="finance-summary-card finance-card-discounts">
            ...
            <div class="finance-card-content">
                <span class="finance-card-label">{{ trans('admin.students.finance.total_discounts') }}</span>
                <span class="finance-card-value">{{ $summary['total_discounts'] }}</span>
                <span class="finance-card-count">{{ $summary['discount_count'] }}
                    {{ trans('admin.students.finance.discounts_label') }}</span>
            </div>
        </div>
        ...
        <div
            ...
            <div class="finance-card-content">
                <span class="finance-card-label">{{ trans('admin.students.finance.balance') }}</span>
    ...
    <ul class="nav nav-tabs finance-nav-tabs" id="financeTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="ledger-tab" data-toggle="tab" href="#ledger" role="tab">
                ...
                {{ trans('admin.students.finance.tabs.ledger') }}
        ...
        <li class="nav-item">
            <a class="nav-link" id="invoices-tab" data-toggle="tab" href="#invoices" role="tab">
                ...
                {{ trans('admin.students.finance.tabs.invoices') }}
        ...
        <li class="nav-item">
            <a class="nav-link" id="receipts-tab" data-toggle="tab" href="#receipts" role="tab">
                ...
                {{ trans('admin.students.finance.tabs.receipts') }}
        ...
        <li class="nav-item">
            <a class="nav-link" id="discounts-tab" data-toggle="tab" href="#discounts" role="tab">
                ...
                {{ trans('admin.students.finance.tabs.discounts') }}
        ...
        @if ($vouchers->count() > 0)
            <li class="nav-item">
                <a class="nav-link" id="vouchers-tab" data-toggle="tab" href="#vouchers" role="tab">
                    ...
                    {{ trans('admin.students.finance.tabs.vouchers') }}
    ...
    <div class="tab-content finance-tab-content" id="financeTabContent">
        ...
        <div class="tab-pane fade show active" id="ledger" role="tabpanel">
            @if ($ledger->count() > 0)
                <div class="finance-table-wrapper">
                    <table class="table finance-table mb-0">
                        <thead>
                            <tr>
                                <th>{{ trans('admin.students.finance.table.date') }}</th>
                                <th>{{ trans('admin.students.finance.table.type') }}</th>
                                <th>{{ trans('admin.students.finance.table.description') }}</th>
                                <th class="text-danger">{{ trans('admin.students.finance.table.debit') }}</th>
                                <th class="text-success">{{ trans('admin.students.finance.table.credit') }}</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            @else
                @include('admin.students.partials.finance_empty_state', [
                    'icon' => 'la-book',
                    'message' => trans('admin.students.finance.empty.ledger'),
                ])
            @endif
        </div>
        ...
        <div class="tab-pane fade" id="invoices" role="tabpanel">
            ...
            @else
                @include('admin.students.partials.finance_empty_state', [
                    ...
                    'message' => trans('admin.students.finance.empty.invoices'),
                ])
            @endif
        </div>
        ...
        <div class="tab-pane fade" id="receipts" role="tabpanel">
                    ...
                    @foreach ($receipts as $receipt)
                        <div class="finance-item-card receipt-card">
                            <div class="finance-item-header">
                                ...
                                <div class="finance-item-meta">
                                    <span
                                        class="finance-item-title">{{ $receipt['payment_gateway'] ?? trans('admin.students.finance.cash') }}</span>
            ...
            @else
                @include('admin.students.partials.finance_empty_state', [
                    'icon' => 'la-receipt',
                    'message' => trans('admin.students.finance.empty.receipts'),
                ])
            @endif
        </div>
        ...
        <div class="tab-pane fade" id="discounts" role="tabpanel">
            ...
            @else
                @include('admin.students.partials.finance_empty_state', [
                    'icon' => 'la-tags',
                    'message' => trans('admin.students.finance.empty.discounts'),
                ])
            @endif
        </div>
                    ...
                    @foreach ($vouchers as $voucher)
                        <div class="finance-item-card voucher-card">
                            <div class="finance-item-header">
                                ...
                                <div class="finance-item-meta">
                                    <span
                                        class="finance-item-title">{{ $voucher['payment_gateway'] ?? trans('admin.students.finance.cash') }}</span>
