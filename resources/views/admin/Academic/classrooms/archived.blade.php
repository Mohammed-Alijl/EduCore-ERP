...
@section('title', __('admin.Academic.classrooms.archived'))
...
@section('page-header')
    <div class="page-header-archive d-flex justify-content-between align-items-center mt-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h4 class="mb-1 text-white font-weight-bold">{{ __('admin.Academic.classrooms.archived') }}</h4>
                <p class="mb-0 text-white-50 tx-13">{{ __('admin.Academic.classrooms.archived_list') }}</p>
            </div>
        </div>
        <div>
            <a href="{{ route('admin.Academic.classrooms.index') }}" class="btn btn-light shadow-sm" style="border-radius: 8px; font-weight: 600;">
...
@section('content')
    <div class="archive-alert shadow-sm">
        ...
        <div>
            ...
            <p class="text-muted mb-0 tx-13">{{__('admin.Academic.grades.warning_body')}}</p>
        </div>
    </div>
                ...
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="grade_filter" class="form-label font-weight-bold">{{ __('admin.Academic.classrooms.fields.grade') }}:</label>
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap table-archive table-hover" id="archivedClassroomsTable">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">{{ __('admin.Academic.classrooms.fields.name') }}</th>
                                <th class="wd-20p border-bottom-0">{{ __('admin.Academic.classrooms.fields.grade') }}</th>
                                <th class="wd-10p border-bottom-0">{{ __('admin.Academic.classrooms.fields.status') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm view-btn"
                                           ...
                                           data-notes="{{ $classroom->notes ?? __('admin.Academic.grades.no_notes') }}"
                                        ...
                                        href="#"
                                           data-url="{{ route('admin.Academic.classrooms.restore', $classroom->id) }}"
                                        ...
                                        @can('delete_classrooms')
                                            <a class="btn btn-sm btn-archive-delete delete-item"
                                               href="#"
                                               data-id="{{ $classroom->id }}"
                                               data-url="{{ route('admin.Academic.classrooms.forceDelete', $classroom->id) }}"
                                               data-name="{{ $classroom->name }}">
    ...
    @include('admin.Academic.classrooms.show_modal')
@endsection
