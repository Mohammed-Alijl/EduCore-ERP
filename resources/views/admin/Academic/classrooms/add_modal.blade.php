    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('admin.Academic.classrooms.add') }}</h6>
                <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
    <form action="{{ route('admin.Academic.classrooms.store') }}"
          method="POST"
          class="ajax-form"
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__('admin.Academic.classrooms.fields.name_ar')}} <span class="text-danger">*</span></label>
                        <input type="text" name="name[ar]" id="name_ar" class="form-control" placeholder="{{__('admin.Academic.classrooms.fields.name')}}" required minlength="3" maxlength="30" autocomplete="off">
                        <span class="text-danger error-text name_ar_error"></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__('admin.Academic.classrooms.fields.name_en')}} <span class="text-danger">*</span></label>
                        <input type="text" name="name[en]" id="name_en" class="form-control" placeholder="{{__('admin.Academic.classrooms.fields.name')}}" required minlength="3" maxlength="30" autocomplete="off">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>{{ __('admin.Academic.classrooms.fields.grade') }} <span class="text-danger">*</span></label>
