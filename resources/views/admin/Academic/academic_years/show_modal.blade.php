        ...
        <div class="modal-content year-show-modal-content">
            <div class="modal-header year-show-modal-header">
                <h5 class="modal-title font-weight-bold">
                    ...
                    {{ __('admin.Academic.academic_years.show') }}
                </h5>
            ...
            <div class="modal-body p-4">
                <div class="year-show-banner mb-4">
                    ...
                    <p class="mb-0 text-muted">{{ __('admin.Academic.academic_years.year_details') }}</p>
                </div>

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="year-show-card-item">
                            <small>{{ __('admin.Academic.academic_years.fields.starts_at') }}</small>
                            <h6 id="show_year_starts_at" class="mb-0">-</h6>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="year-show-card-item">
                            <small>{{ __('admin.Academic.academic_years.fields.ends_at') }}</small>
                            <h6 id="show_year_ends_at" class="mb-0">-</h6>
                        </div>
                    </div>
                    <div class="col-md-12 mb-0">
                        <div class="year-show-card-item">
                            <small>{{ __('admin.Academic.academic_years.fields.is_current') }}</small>
