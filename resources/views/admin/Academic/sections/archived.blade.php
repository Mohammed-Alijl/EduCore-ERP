    ...
    <div class="page-header-archive d-flex justify-content-between align-items-center mt-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="mb-0 text-white-50 tx-13">{{ __('admin.Academic.sections.title') }}</p>
            </div>
        </div>
        <div>
            <a href="{{ route('admin.Academic.sections.index') }}" class="btn btn-light shadow-sm" style="border-radius:8px;font-weight:600;">
...
@section('content')
    ...
    <div class="archive-alert shadow-sm">
        ...
        <div>
            <h6 class="text-danger font-weight-bold mb-1">{{ trans('admin.Academic.sections.warning_title') ?? trans('admin.global.warning') }}</h6>
            <p class="text-muted mb-0 tx-13">{{ trans('admin.Academic.sections.warning_body') ?? trans('admin.global.archive_warning') }}</p>
        </div>
    </div>
        ...
        <div class="row align-items-end">
            <div class="col-md-4 mb-2 mb-md-0">
                <label class="tx-12 font-weight-600 text-muted mb-1">
                    {{ trans('admin.Academic.sections.fields.grade') }}
                </label>
            ...
            <div class="col-md-4 mb-2 mb-md-0">
                <label class="tx-12 font-weight-600 text-muted mb-1">
                    {{ trans('admin.Academic.sections.fields.classroom') }}
                </label>
        ...
        <div class="table-responsive px-3 pb-3" style="padding-top: 1rem;">
            <table class="table" id="archivedSectionsTable" style="width:100%">
                ...
                <tr>
                    ...
                    <th class="border-bottom-0">{{ trans('admin.Academic.sections.fields.name') }}</th>
                    <th class="border-bottom-0">{{ trans('admin.Academic.sections.fields.grade') }}</th>
                    <th class="border-bottom-0">{{ trans('admin.Academic.sections.fields.classroom') }}</th>
...
@section('js')
    ...
    $(function () {
        ...
        var archiveTable = $('#archivedSectionsTable').DataTable({
            ...
            ajax: {
                url: '{{ route("admin.Academic.sections.archived") }}',
                data: function (d) {
