...
@section('title', __('admin.Academic.sections.title'))
...
@section('css')
    ...
    {{-- Section CRUD Styles --}}
    <link href="{{ URL::asset('assets/admin/css/Academic/section/section-crud.css') }}" rel="stylesheet">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.Academic.sections.title') }}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center">
            @can('view-archived_sections')
                <div class="mb-3 mb-xl-0 ml-2">
                    <a class="btn btn-modern btn-danger shadow-sm" href="{{ route('admin.Academic.sections.archived') }}">
                        <i class="las la-archive tx-16 mr-1 ml-1"></i>
                        {{ trans('admin.Academic.sections.archived') }}
                    </a>
                </div>
            @endcan
            @can('create_sections')
                <div class="mb-3 mb-xl-0 ml-2">
                    <a class="modal-effect btn btn-primary btn-modern shadow-sm"
                       data-effect="effect-scale" data-toggle="modal" href="#addModal">
                        ...
                        {{ trans('admin.Academic.sections.add') }}
                    </a>
                </div>
            @endcan
        </div>
...
@section('content')
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            <i class="las la-layer-group mr-1"></i> {{ trans('admin.Academic.sections.fields.grade') }}
                        </label>
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            <i class="las la-chalkboard mr-1"></i> {{ trans('admin.Academic.sections.fields.classroom') }}
                        </label>
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            <i class="las la-toggle-on mr-1"></i> {{ trans('admin.Academic.sections.fields.status') }}
                        </label>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-md-nowrap" id="sections_table">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">{{ __('admin.Academic.sections.fields.name') }}</th>
                                <th class="wd-15p border-bottom-0">{{ __('admin.Academic.sections.fields.grade') }}</th>
                                <th class="wd-15p border-bottom-0">{{ __('admin.Academic.sections.fields.classroom') }}</th>
                                <th class="wd-10p border-bottom-0 text-center">{{ __('admin.Academic.sections.fields.status') }}</th>
    ...
    @include('admin.Academic.sections.add_modal')
    @include('admin.Academic.sections.edit_modal')
    @include('admin.Academic.sections.show_modal')
