        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
            ...
            <div class="modal-header bg-light border-bottom-0 pb-0" style="padding: 1.5rem 2rem;">
                <div class="d-flex align-items-center w-100">
                    ...
                    <div>
                        <h5 class="modal-title font-weight-bold text-dark mb-1" id="addModalLabel">{{ __('admin.Academic.subjects.add') }}</h5>
                        <p class="text-muted mb-0" style="font-size: 0.85rem;">{{ __('admin.Academic.subjects.section_basic_hint') }}</p>
                    </div>
            ...
            <!-- ─── Form Start ─── -->
            <form id="createSubjectForm" action="{{ route('admin.Academic.subjects.store') }}" method="POST"
                ...
                <div class="modal-body" style="padding: 1.5rem 2rem;">
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h6 class="font-weight-bold mb-0 text-uppercase" style="letter-spacing: 0.5px; font-size: 0.85rem; color: #4e73df;">{{ __('admin.Academic.subjects.section_basic') }}</h6>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label font-weight-bold text-muted" style="font-size: 0.8rem;" for="name_ar">
                                    {{ __('admin.Academic.subjects.fields.name_ar') }} <span class="text-danger">*</span>
                                </label>
                                <div class="input-group" style="box-shadow: 0 2px 6px rgba(0,0,0,0.02); border-radius: 10px; overflow: hidden;">
                                    ...
                                    <input type="text" class="form-control border-left-0 pl-0" id="name_ar" name="name[ar]" placeholder="{{ __('admin.Academic.subjects.placeholders.name_ar') }}" style="border: 1.5px solid #e3e6f0; height: 45px;" data-parsley-required="true" required>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label font-weight-bold text-muted" style="font-size: 0.8rem;" for="name_en">
                                    {{ __('admin.Academic.subjects.fields.name_en') }} <span class="text-danger">*</span>
                                </label>
                                <div class="input-group" style="box-shadow: 0 2px 6px rgba(0,0,0,0.02); border-radius: 10px; overflow: hidden;">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control border-left-0 pl-0" id="name_en" name="name[en]" placeholder="{{ __('admin.Academic.subjects.placeholders.name_en') }}" style="border: 1.5px solid #e3e6f0; height: 45px;" data-parsley-required="true" required>
                                </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <label class="form-label font-weight-bold text-muted mb-2" style="font-size: 0.8rem;">
                                    {{ __('admin.Academic.subjects.fields.status') }} <span class="text-danger">*</span>
                                </label>
                                <div class="d-flex gap-3" style="gap: 1rem;">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label class="custom-control-label fw-bold" for="status_active" style="cursor: pointer;">
                                            <span class="badge badge-light px-3 py-2 border text-success" style="border-radius: 8px; font-size: 0.85rem;"><i class="las la-check-circle mr-1 ml-1"></i> {{ __('admin.Academic.subjects.active') }}</span>
                                        </label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label class="custom-control-label fw-bold" for="status_inactive" style="cursor: pointer;">
                                            <span class="badge badge-light px-3 py-2 border text-danger" style="border-radius: 8px; font-size: 0.85rem;"><i class="las la-times-circle mr-1 ml-1"></i> {{ __('admin.Academic.subjects.inactive') }}</span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h6 class="font-weight-bold mb-0 text-uppercase" style="letter-spacing: 0.5px; font-size: 0.85rem; color: #10b981;">{{ __('admin.Academic.subjects.section_academic') }}</h6>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="form-label font-weight-bold text-muted" style="font-size: 0.8rem;" for="specialization_id">
                                    <i class="las la-layer-group text-warning mr-1 ml-1"></i>{{ __('admin.Academic.subjects.fields.specialization_id') }} <span class="text-danger">*</span>
                                </label>
                                <select class="form-control" id="add_specialization_id" name="specialization_id" style="border: 1.5px solid #e3e6f0; height: 45px; border-radius: 10px; box-shadow: 0 2px 6px rgba(0,0,0,0.02);" data-parsley-required="true" required>
                                    <option value="" selected disabled>{{ __('admin.Academic.subjects.choose_specializations') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label font-weight-bold text-muted" style="font-size: 0.8rem;" for="grade_id">
                                    <i class="las la-graduation-cap text-primary mr-1 ml-1"></i>{{ __('admin.Academic.subjects.fields.grade_id') }} <span class="text-danger">*</span>
                                </label>
                                <select class="form-control" id="add_grade_id" name="grade_id" style="border: 1.5px solid #e3e6f0; height: 45px; border-radius: 10px; box-shadow: 0 2px 6px rgba(0,0,0,0.02);" data-parsley-required="true" required>
                                    <option value="" selected disabled>{{ __('admin.Academic.subjects.all_grades') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label font-weight-bold text-muted" style="font-size: 0.8rem;" for="classroom_id">
                                    <i class="las la-chalkboard text-info mr-1 ml-1"></i>{{ __('admin.Academic.subjects.fields.classroom_id') }} <span class="text-danger">*</span>
                                </label>
                                <div class="position-relative">
                                    <select class="form-control" id="add_classroom_id" name="classroom_id" style="border: 1.5px solid #e3e6f0; height: 45px; border-radius: 10px; box-shadow: 0 2px 6px rgba(0,0,0,0.02); background-color: #f8f9fc;" data-parsley-required="true" disabled required>
                                        <option value="" selected disabled>{{ __('admin.Academic.subjects.classroom_placeholder') }}</option>
                                    </select>
...
$(function () {
    ...
    $('#add_grade_id').on('change', function () {
        ...
        select.empty()
              .append('<option value="" selected disabled>{{ __('admin.Academic.subjects.classroom_placeholder') }}</option>')
              .prop('disabled', true)
        ...
        spinner.show();
        $.get("{{ route('admin.Academic.classrooms.by-grade') }}", { grade_id: gradeId })
...
<link href="{{ URL::asset('assets/admin/css/LMS/subject/modals.css') }}" rel="stylesheet">
