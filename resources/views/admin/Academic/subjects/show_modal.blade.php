    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
            ...
            <div class="position-relative" style="background: linear-gradient(135deg, #1a1c5e 0%, #3a3fbf 50%, #5e72e4 100%); padding: 2.5rem 2rem 4rem;">
                ...
                <div class="d-flex align-items-center mt-3">
                    ...
                    <div class="text-white">
                        <p class="mb-1 text-uppercase" style="font-size: 0.7rem; letter-spacing: 2px; opacity: 0.7;">{{ __('admin.Academic.subjects.title') }}</p>
                        ...
                        <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <p class="mb-0 text-uppercase font-weight-bold text-muted" style="font-size: 0.7rem; letter-spacing: 1px;">{{ __('admin.Academic.subjects.section_academic') }}</p>
                                        <h6 class="mb-0 font-weight-bold text-dark">{{ __('admin.Academic.subjects.fields.grade_id') }} &amp; {{ __('admin.Academic.subjects.fields.classroom_id') }}</h6>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <p class="text-muted mb-0" style="font-size: 0.72rem;">{{ __('admin.Academic.subjects.fields.grade_id') }}</p>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <p class="text-muted mb-0" style="font-size: 0.72rem;">{{ __('admin.Academic.subjects.fields.classroom_id') }}</p>
                        ...
                        <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <p class="mb-0 text-uppercase font-weight-bold text-muted" style="font-size: 0.7rem; letter-spacing: 1px;">{{ __('admin.Academic.subjects.fields.specialization_id') }}</p>
                                        <h6 class="mb-0 font-weight-bold text-dark">{{ __('admin.Academic.subjects.fields.specialization_id') }}</h6>
                                    </div>
                                </div>
                                <hr style="border-top: 1px dashed #e3e6f0; margin: 0.75rem 0;">
                                <div class="text-center pt-2">
                                    ...
                                    <p class="text-muted mt-1" style="font-size: 0.8rem;">{{ __('admin.Academic.subjects.fields.specialization_id') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer bg-light border-top-0" style="padding: 1.25rem 2rem; border-radius: 0 0 20px 20px;">
                ...
                @can('edit_subjects')
                @if(!request()->routeIs('admin.Academic.subjects.archived'))
                <a href="javascript:void(0)" class="btn btn-primary shadow-sm show-to-edit-btn"
                   style="border-radius: 8px; font-weight: 600; padding: 0.6rem 1.5rem; background: linear-gradient(135deg, #4e73df, #224abe); border: none;">
                    <i class="las la-pen mr-1 ml-1"></i> {{ __('admin.Academic.subjects.edit') }}
                </a>
                @endif
                @endcan
            </div>
...
$(function () {
    ...
    $('body').on('click', '.show-subject-btn', function () {
        ...
        if (status === 1) {
            $badge.text("{{ __('admin.Academic.subjects.active') }}")
                  .css({ background: 'rgba(28,200,138,0.2)', color: '#1cc88a', border: '1px solid rgba(28,200,138,0.4)' });
        } else {
            $badge.text("{{ __('admin.Academic.subjects.inactive') }}")
