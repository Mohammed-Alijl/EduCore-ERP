...
@section('title', __('admin.CMS.cms.edit_section') . ' - ' . __('admin.CMS.cms.sections.' . $section->section_key))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a href="{{ route('admin.CMS.cms.index') }}">{{ __('admin.CMS.cms.sections_title') }}</a></span>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.CMS.cms.sections.' . $section->section_key) }}</span>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="cms-header">
                    <div class="cms-header-content">
                        <h2 class="cms-header-title">
                            ...
                            {{ __('admin.CMS.cms.edit_section') }}: {{ __('admin.CMS.cms.sections.' . $section->section_key) }}
                        </h2>
                        <p class="cms-header-subtitle">{{ __('admin.CMS.cms.section_descriptions.' . $section->section_key) }}</p>
                    </div>
                    <a href="{{ route('admin.CMS.cms.index') }}" class="btn btn-outline-secondary btn-sm">
                        <i class="las la-arrow-left"></i> {{ __('admin.CMS.cms.back_to_sections') }}
                    </a>
                </div>

                {{-- Form --}}
                <form id="section-form" method="POST" action="{{ route('admin.Academic.sections.update', $section) }}"
                    ...
                    <div class="cms-body">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.CMS.cms.fields.title_en') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.CMS.cms.fields.title_ar') }}</label>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.CMS.cms.fields.subtitle_en') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.CMS.cms.fields.subtitle_ar') }}</label>
                        ...
                        @if(in_array($section->section_key, ['features', 'faq', 'testimonials']))
                            <div class="form-section">
                                <h3 class="section-title">
                                    ...
                                    {{ __('admin.CMS.cms.content') }} — {{ __('admin.CMS.cms.sections.' . $section->section_key) }}
                                </h3>
                                        ...
                                        @foreach($items as $index => $item)
                                            <div class="repeater-item card p-3 mb-3">
                                                <div class="d-flex justify-content-between mb-2">
                                                    <strong>{{ __('admin.CMS.cms.content') }} #{{ $index + 1 }}</strong>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                @empty
                                    <div class="col-12">
                                        <p class="text-muted">{{ __('admin.CMS.cms.sections.' . $section->section_key) }} {{ __('admin.CMS.cms.content') }}</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.CMS.cms.fields.is_visible') }}</label>
                                        <select name="is_visible" class="form-control">
                                            <option value="1" {{ $section->is_visible ? 'selected' : '' }}>{{ __('admin.CMS.cms.visible') }}</option>
                                            <option value="0" {{ !$section->is_visible ? 'selected' : '' }}>{{ __('admin.CMS.cms.hidden') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#add-item').on('click', function() {
                ...
                let html = '<div class="repeater-item card p-3 mb-3">' +
                    '<div class="d-flex justify-content-between mb-2">' +
                    '<strong>{{ __("admin.CMS.cms.content") }} #' + (itemIndex + 1) + '</strong>' +
