...
@section('title', __('admin.CMS.cms.legal_title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.CMS.cms.legal_title') }}</span>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="cms-header">
                    <div class="cms-header-content">
                        <h2 class="cms-header-title">
                            ...
                            {{ __('admin.CMS.cms.legal_title') }}
                        </h2>
                        <p class="cms-header-subtitle">{{ __('admin.CMS.cms.legal_subtitle') }}</p>
                    </div>
                </div>
                ...
                <div class="cms-body">
                    @if($pages->isEmpty())
                        <div class="text-center py-5">
                            ...
                            <p class="mt-3 text-muted">{{ __('admin.CMS.cms.no_legal_pages') }}</p>
                        </div>
                    @else
                                ...
                                <div class="cms-legal-card">
                                    ...
                                    <div class="cms-legal-info">
                                        ...
                                        <span class="badge badge-{{ $page->is_published ? 'success' : 'secondary' }}">
                                            {{ $page->is_published ? __('admin.CMS.cms.published') : __('admin.CMS.cms.draft') }}
                                        </span>
                                    </div>
                                    <div class="cms-legal-actions">
                                        @can('edit_cms')
                                            <a href="{{ route('admin.CMS.cms.legal.edit', $page) }}"
