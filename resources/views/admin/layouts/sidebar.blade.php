        ...
        <div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
            <div class="tabs-menu ">
                ...
                <ul class="nav panel-tabs">
                    <li class=""><a href="#messages" class="active" data-toggle="tab"><i
                                class="las la-comments tx-18 ml-2"></i>{{ __('admin.header.messages') }}</a></li>
                    <li><a href="#notifications" data-toggle="tab"><i class="las la-bell tx-18  ml-2"></i>
                            {{ __('admin.header.notifications') }}</a></li>
                </ul>
            </div>
                        ...
                        <div class="list-group-item d-flex  align-items-center">
                            <div class="ml-3">
                                <span class="avatar avatar-lg brround cover-image"
                                    data-image-src="{{ URL::asset('assets/admin/img/faces/12.jpg') }}"><span
