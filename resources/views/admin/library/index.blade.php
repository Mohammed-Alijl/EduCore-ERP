...
@section('title', trans('admin.books.title'))
        ...
        <div class="my-auto w-100">
            <div class="card library-hero-card bg-primary text-white shadow-sm mb-0">
                <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h4 class="library-hero-title">{{ trans('admin.books.title') }}</h4>
                        <p class="library-hero-subtitle">{{ trans('admin.books.sub_title') }}</p>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl col-lg-4 col-md-6 mb-3">
                            <label class="form-label">{{ trans('admin.books.form.select_grade') }}</label>
                        ...
                        <div class="col-xl col-lg-4 col-md-6 mb-3">
                            <label class="form-label">{{ trans('admin.books.form.select_classroom') }}</label>
                        ...
                        <div class="col-xl col-lg-4 col-md-6 mb-3">
                            <label class="form-label">{{ trans('admin.books.form.select_section') }}</label>
                        ...
                        <div class="col-xl col-lg-4 col-md-6 mb-3">
                            <label class="form-label">{{ trans('admin.books.form.select_teacher') }}</label>
                        ...
                        <div class="col-xl col-lg-4 col-md-6 mb-3">
                            <label class="form-label">{{ trans('admin.books.form.select_subject') }}</label>
                    ...
                    <div class="table-responsive">
                        <table id="books_table" class="table text-md-nowrap table-hover">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ trans('admin.books.table.title') }}</th>
                                    <th>{{ trans('admin.books.table.academic_target') }}</th>
                                    <th>{{ trans('admin.books.table.teacher') }}</th>
                                    <th>{{ trans('admin.books.table.subject') }}</th>
                                    <th>{{ trans('admin.books.table.actions') }}</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
