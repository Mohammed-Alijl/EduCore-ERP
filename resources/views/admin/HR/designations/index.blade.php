...
@section('title', __('admin.HR.designations.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.HR.designations.title') }}</span>
            </div>
        </div>
            ...
            @can('create_designations')
                <div class="mb-3 mb-xl-0 ml-2">
                    <a class="modal-effect btn btn-primary btn-with-icon btn-block" data-effect="effect-scale"
                        ...
                        <i class="fas fa-plus-circle"></i> {{ __('admin.HR.designations.add') }}
                    </a>
                </div>
            @endcan
        </div>
...
@section('content')
                        ...
                        <table class="table table-hover text-md-nowrap" id="designations_table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-18p border-bottom-0">{{ __('admin.HR.designations.fields.name') }}</th>
                                    <th class="wd-15p border-bottom-0">{{ __('admin.HR.designations.fields.department') }}
                                    </th>
                                    <th class="wd-15p border-bottom-0">{{ __('admin.HR.designations.fields.description') }}
                                    </th>
                                    <th class="wd-10p border-bottom-0 text-center">
                                        {{ __('admin.HR.designations.fields.default_salary') }}</th>
                                    <th class="wd-8p border-bottom-0 text-center">
                                        {{ __('admin.HR.designations.fields.can_teach') }}</th>
                                    <th class="wd-8p border-bottom-0 text-center">
                                        {{ __('admin.HR.designations.fields.employees_count') }}</th>
                            ...
                            <tbody>
                                @foreach ($designations as $designation)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="desig-description-cell d-inline-block">{{ $designation->description ?: __('admin.HR.designations.no_description') }}</span>
                                        </td>
                                            ...
                                            <td class="text-center">
                                                @can('view_designations')
                                                    <a class="btn btn-outline-primary btn-sm desig-action-btn desig-show-btn"
                                                        ...
                                                        title="{{ __('admin.HR.designations.show') }}">
                                                ...
                                                @can('edit_designations')
                                                    <a class="btn btn-outline-info btn-sm desig-action-btn edit-btn" href="#"
                                                        ...
                                                        data-url="{{ route('admin.HR.designations.update', $designation->id) }}"
                                                        data-name="{{ $designation->name }}"
                                                        data-description="{{ $designation->description }}"
                                                        data-department_id="{{ $designation->department_id }}"
                                                        data-default_salary="{{ $designation->default_salary }}"
                                                        data-can_teach="{{ $designation->can_teach }}"
                                                        title="{{ __('admin.HR.designations.edit') }}">
                                                ...
                                                @can('delete_designations')
                                                    <a class="modal-effect btn btn-outline-danger btn-sm desig-action-btn delete-item"
                                                        ...
                                                        data-url="{{ route('admin.HR.designations.destroy', $designation->id) }}"
                                                        data-name="{{ $designation->name }}"
                                                        title="{{ __('admin.HR.designations.delete') }}">
    ...
    @include('admin.HR.designations.create_modal')
    @include('admin.HR.designations.edit_modal')
    @include('admin.HR.designations.show_modal')
