...
@section('title', __('admin.HR.departments.title'))
...
@section('css')
    ...
    <link href="{{ URL::asset('assets/admin/css/HR/department/department-crud.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/admin/css/HR/department/show.css') }}" rel="stylesheet">
@endsection
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.HR.departments.title') }}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center">
            ...
            <div class="mb-3 mb-xl-0 ml-2">
                <a class="modal-effect btn btn-primary btn-with-icon btn-block"
                   ...
                   data-toggle="modal"
                   href="#createModal">
                    <i class="fas fa-plus-circle"></i> {{ __('admin.HR.departments.add') }}
                </a>
            </div>
            @endcan
        </div>
...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-md-nowrap" id="departments_table">
                            ...
                            <tr>
                                ...
                                <th class="wd-25p border-bottom-0">{{ __('admin.HR.departments.fields.name') }}</th>
                                <th class="wd-30p border-bottom-0">{{ __('admin.HR.departments.fields.description') }}</th>
                                <th class="wd-10p border-bottom-0 text-center">{{ __('admin.HR.departments.fields.employees_count') }}</th>
                                <th class="wd-10p border-bottom-0 text-center">{{ __('admin.HR.departments.fields.designations_count') }}</th>
                            ...
                            @foreach($departments as $department)
                                <tr>
                                    ...
                                    <td>
                                        <span class="dept-description-cell d-inline-block">{{ $department->description ?: __('admin.HR.departments.no_description') }}</span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-outline-primary btn-sm dept-action-btn show-btn"
                                           ...
                                           title="{{ __('admin.HR.departments.show') }}">
                                        ...
                                        <a class="btn btn-outline-info btn-sm dept-action-btn edit-btn"
                                           ...
                                           data-url="{{ route('admin.HR.departments.update', $department->id) }}"
                                           data-name="{{ $department->name }}"
                                           data-description="{{ $department->description }}"
                                           title="{{ __('admin.HR.departments.edit') }}">
                                        ...
                                        @can('delete_department')
                                            <a class="modal-effect btn btn-outline-danger btn-sm dept-action-btn delete-item"
                                               ...
                                               data-url="{{ route('admin.HR.departments.destroy', $department->id) }}"
                                               data-name="{{ $department->name }}"
                                               title="{{ __('admin.HR.departments.delete') }}">
    ...
    @include('admin.HR.departments.create_modal')
    @include('admin.HR.departments.edit_modal')
    @include('admin.HR.departments.show_modal')
