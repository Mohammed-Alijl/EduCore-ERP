...
@section('title', __('admin.Settings.days_of_week.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.Settings.days_of_week.title') }}</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="card days-glass-card">
                ...
                <div class="days-header">
                    <h2 class="days-header-title">
                        ...
                        {{ __('admin.Settings.days_of_week.title') }}
                    </h2>
                    <p class="days-header-subtitle">{{ __('admin.Settings.days_of_week.subtitle') }}</p>
                </div>
                            ...
                            <div class="day-card {{ $day->is_active ? 'is-active' : 'is-inactive' }} {{ $day->is_weekend ? 'is-weekend' : '' }}"
                                ...
                                @if ($day->is_weekend)
                                    <span class="weekend-badge">
                                        <i class="las la-moon"></i> {{ __('admin.Settings.days_of_week.weekend') }}
                                    </span>
                                @endif
                                ...
                                <div class="day-status-badge">
                                    @if ($day->is_active)
                                        ...
                                        {{ __('admin.Settings.days_of_week.active') }}
                                    @else
                                        <i class="las la-ban"></i>
                                        {{ __('admin.Settings.days_of_week.inactive') }}
                                    @endif
                                </div>

                                @can('edit_daysOfWeek')
                                    <div class="day-toggle-wrapper d-flex align-items-center justify-content-between">
                                        <span class="toggle-label">{{ __('admin.Settings.days_of_week.toggle_status') }}</span>
                    ...
                    <div class="days-stats">
                        <div class="stat-item">
                            ...
                            <div class="stat-info">
                                ...
                                <span class="stat-label">{{ __('admin.Settings.days_of_week.stats.active') }}</span>
                            </div>
                        </div>
                        <div class="stat-item">
                            ...
                            <div class="stat-info">
                                ...
                                <span class="stat-label">{{ __('admin.Settings.days_of_week.stats.inactive') }}</span>
                            </div>
                        </div>
                        <div class="stat-item">
                            ...
                            <div class="stat-info">
                                ...
                                <span class="stat-label">{{ __('admin.Settings.days_of_week.stats.weekend') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    @can('edit_daysOfWeek')
                        <div class="days-quick-actions">
                            <button type="button" class="btn-action btn-activate-all" id="activate-all">
                                ...
                                {{ __('admin.Settings.days_of_week.activate_all') }}
                            </button>
                            <button type="button" class="btn-action btn-deactivate-all" id="deactivate-all">
                                <i class="las la-ban"></i>
                                {{ __('admin.Settings.days_of_week.deactivate_all') }}
                            </button>
                        </div>
                    @endcan
                </div>
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            const badgeHtml = isActive ?
                                '<i class="las la-check"></i> {{ __('admin.Settings.days_of_week.active') }}' :
                                '<i class="las la-ban"></i> {{ __('admin.Settings.days_of_week.inactive') }}';
