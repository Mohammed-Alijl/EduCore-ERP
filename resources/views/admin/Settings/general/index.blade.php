...
@section('title', __('admin.Settings.general_settings.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.Settings.general_settings.title') }}</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="card settings-glass-card">
                ...
                <div class="settings-header">
                    <h2 class="settings-header-title">
                        ...
                        {{ __('admin.Settings.general_settings.title') }}
                    </h2>
                    <p class="settings-header-subtitle">{{ __('admin.Settings.general_settings.subtitle') }}</p>
                </div>
                    ...
                    <div class="settings-body">
                        ...
                        <div class="form-section">
                            <h3 class="section-title">
                                ...
                                {{ __('admin.Settings.general_settings.sections.school_identity') }}
                            </h3>

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.school_name_ar') }}
                                        ...
                                        <input type="text" name="school_name[ar]" class="form-control"
                                            ...
                                            placeholder="{{ __('admin.Settings.general_settings.placeholders.school_name_ar') }}"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.school_name_en') }}
                                            <span class="text-danger">*</span></label>
                                        <input type="text" name="school_name[en]" class="form-control"
                                            value="{{ old('school_name.en', $settings->getTranslation('school_name', 'en')) }}"
                                            placeholder="{{ __('admin.Settings.general_settings.placeholders.school_name_en') }}"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.logo') }}</label>
                                        <div class="logo-preview-container" id="logo-preview-container">
                                            ...
                                            @else
                                                <div class="logo-placeholder">
                                                    ...
                                                    <span>{{ __('admin.Settings.general_settings.fields.logo') }}</span>
                                                </div>
                                            @endif
                                        </div>
                        ...
                        <div class="form-section">
                            <h3 class="section-title">
                                ...
                                {{ __('admin.Settings.general_settings.sections.contact_info') }}
                            </h3>

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.email') }}</label>
                                        <input type="email" name="email" class="form-control"
                                            value="{{ old('email', $settings->email) }}"
                                            placeholder="{{ __('admin.Settings.general_settings.placeholders.email') }}">
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.phone') }}</label>
                                        <input type="text" name="phone" class="form-control"
                                            value="{{ old('phone', $settings->phone) }}"
                                            placeholder="{{ __('admin.Settings.general_settings.placeholders.phone') }}">
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.fax') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.Settings.general_settings.fields.website') }}</label>
                                        <input type="url" name="website" class="form-control"
                                            value="{{ old('website', $settings->website) }}"
                                            placeholder="{{ __('admin.Settings.general_settings.placeholders.website') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            <h3 class="section-title">
                                ...
                                {{ __('admin.Settings.general_settings.sections.address') }}
                            </h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            class="form-label">{{ __('admin.Settings.general_settings.fields.address_ar') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            class="form-label">{{ __('admin.Settings.general_settings.fields.address_en') }}</label>
                        ...
                        <div class="form-section">
                            <h3 class="section-title">
                                ...
                                {{ __('admin.Settings.general_settings.sections.academic_config') }}
                            </h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label
                                            class="form-label">{{ __('admin.Settings.general_settings.fields.current_academic_year') }}</label>
                        ...
                        <div class="form-section">
                            <h3 class="section-title">
                                ...
                                {{ __('admin.Settings.general_settings.sections.social_media') }}
                            </h3>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">
                                                ...
                                                {{ __('admin.Settings.general_settings.fields.facebook') }}
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">
                                                ...
                                                {{ __('admin.Settings.general_settings.fields.twitter') }}
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">
                                                ...
                                                {{ __('admin.Settings.general_settings.fields.instagram') }}
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">
                                                ...
                                                {{ __('admin.Settings.general_settings.fields.linkedin') }}
                                            </label>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#remove-logo-btn', function(e) {
                ...
                $('#logo-preview-container').html(
                    '<div class="logo-placeholder"><i class="las la-image"></i><span>{{ __('admin.Settings.general_settings.fields.logo') }}</span></div>'
                );
                $('#logo-input').val('');
                $('#remove_logo').val('1');
            });
