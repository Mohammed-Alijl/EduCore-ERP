...
@section('title', __('admin.global.edit') . ' ' . __('admin.System.roles.title'))
@section('css')
            ...
            <div class="card role-glass-card">
                <div class="role-form-header">
                    <div class="role-form-title">
                        ...
                        {{ __('admin.global.edit') }} {{ __('admin.System.roles.title') }}
                    </div>
                ...
                <div class="role-form-body">
                    <form id="editForm" action="{{ route('admin.System.roles.update', $role->id) }}" method="POST" data-parsley-validate="">
                        @csrf
                        @method('PUT')
