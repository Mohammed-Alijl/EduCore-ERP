...
@section('title', trans('admin.System.activity_logs.title'))
...
@section('css')
    ...
    <link href="{{ URL::asset('assets/admin/css/System/activity_logs/activity-logs.css') }}" rel="stylesheet">
@endsection
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('admin.System.activity_logs.title') }}</span>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <div class="card stats-card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1 tx-12">{{ trans('admin.System.activity_logs.stats.total') }}</p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <div class="card stats-card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1 tx-12">{{ trans('admin.System.activity_logs.stats.created') }}</p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <div class="card stats-card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1 tx-12">{{ trans('admin.System.activity_logs.stats.updated') }}</p>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <div class="card stats-card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1 tx-12">{{ trans('admin.System.activity_logs.stats.deleted') }}</p>
            ...
            <div class="card glass-card overflow-hidden">
                <div class="card-header border-0 pb-0">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div>
                            <h5 class="mb-1 font-weight-bold">{{ trans('admin.System.activity_logs.title') }}</h5>
                            <p class="mb-0 text-muted tx-13">
                                {{ trans('admin.System.activity_logs.subtitle') }}
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-end p-3">
                            ...
                            <div class="col-md-2 mb-3 mb-md-0">
                                <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                                    <i class="las la-tag mr-1"></i> {{ trans('admin.System.activity_logs.fields.log_name') }}
                                </label>
                            ...
                            <div class="col-md-2 mb-3 mb-md-0">
                                <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                                    <i class="las la-bolt mr-1"></i> {{ trans('admin.System.activity_logs.fields.event') }}
                                </label>
                            ...
                            <div class="col-md-3 mb-3 mb-md-0">
                                <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                                    ...
                                    {{ trans('admin.System.activity_logs.fields.from') }}
                                </label>
                            ...
                            <div class="col-md-2 mb-3 mb-md-0">
                                <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                                    <i class="las la-calendar mr-1"></i>
                                    {{ trans('admin.System.activity_logs.fields.to') }}
                                </label>
                            ...
                            <div class="col-md-2 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control form-control-modern" id="filter_search"
                                    placeholder="{{ trans('admin.System.activity_logs.fields.search_placeholder') }}">
                            </div>
                        ...
                        <table class="table text-md-nowrap table-hover mb-0" id="activity_logs_table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-12p border-bottom-0">{{ trans('admin.System.activity_logs.fields.log_name') }}
                                    </th>
                                    <th class="wd-10p border-bottom-0">{{ trans('admin.System.activity_logs.fields.event') }}
                                    </th>
                                    <th class="wd-20p border-bottom-0">
                                        {{ trans('admin.System.activity_logs.fields.description') }}</th>
                                    <th class="wd-15p border-bottom-0">{{ trans('admin.System.activity_logs.fields.subject') }}
                                    </th>
                                    <th class="wd-15p border-bottom-0">{{ trans('admin.System.activity_logs.fields.causer') }}
                                    </th>
                                    <th class="wd-13p border-bottom-0">
                                        {{ trans('admin.System.activity_logs.fields.created_at') }}</th>
    ...
    {{-- Details Modal --}}
    @include('admin.System.activity_logs.partials.details_modal')
@endsection
...
@section('js')
    ...
    <script>
        $(function() {
            var datatableUrl = '{{ route('admin.System.activity_logs.datatable') }}';
            var statisticsUrl = '{{ route('admin.System.activity_logs.statistics') }}';
            var showUrl = '{{ route('admin.System.activity_logs.show', ':id') }}';
