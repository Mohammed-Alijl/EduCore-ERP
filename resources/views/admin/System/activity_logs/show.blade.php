...
@section('title', trans('admin.System.activity_logs.show_title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('admin.System.activity_logs.show_title') }}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center">
            <a href="{{ route('admin.System.activity_logs.index') }}" class="btn btn-outline-primary">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="detail-section">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <div class="detail-label">{{ trans('admin.System.activity_logs.fields.subject') }}</div>
                                @if ($log->subject)
                                ...
                                @else
                                    <div class="detail-value text-muted">
                                        {{ trans('admin.System.activity_logs.no_subject') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="detail-section">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <div class="detail-label">{{ trans('admin.System.activity_logs.fields.causer') }}</div>
                                @if ($log->causer)
                                    <div class="detail-value">
                                ...
                                @else
                                    <div class="detail-value text-muted">
                                        {{ trans('admin.System.activity_logs.system_action') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="detail-section">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <div class="detail-label">{{ trans('admin.System.activity_logs.fields.created_at') }}</div>
                                <div class="detail-value">
                    ...
                    @if ($log->batch_uuid)
                        <div class="detail-section">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <div class="detail-label">{{ trans('admin.System.activity_logs.fields.batch_uuid') }}</div>
                                    <div class="detail-value">
