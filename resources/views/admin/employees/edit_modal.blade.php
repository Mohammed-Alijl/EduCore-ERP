    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action=""
                  method="POST"
                  class="ajax-form"
                  data-modal-id="#editEmployeeModal"
                ...
                <div class="modal-body">
                    ...
                    <h6 class="mb-3 text-primary"><i class="fas fa-user-tie"></i> {{ trans('admin.employees.employee_information') }}</h6>

                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.name_ar') }} <span class="text-danger">*</span></label>
                                <input type="text" name="name[ar]" id="edit_emp_name_ar" class="form-control"
                                       placeholder="{{ trans('admin.employees.fields.name_ar') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.name_en') }} <span class="text-danger">*</span></label>
                                <input type="text" name="name[en]" id="edit_emp_name_en" class="form-control"
                                       placeholder="{{ trans('admin.employees.fields.name_en') }}"
                                       required minlength="3" maxlength="100" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.email') }} <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="email" id="edit_emp_email"
                                       placeholder="employee@edu.com" required minlength="5" maxlength="100" autocomplete="off">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.national_id') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control numeric-only" name="national_id" id="edit_emp_national_id"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" class="form-control"
                                       minlength="8" maxlength="30" data-parsley-equalto="#edit_emp_password">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.type') }} <span class="text-danger">*</span></label>
                                <select name="type" id="edit_emp_type" class="form-control select2" required>
                                    <option value="" disabled selected>-- {{ trans('admin.global.select') }} --</option>
                                    @foreach($employee_types as $empType)
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.gender') }} <span class="text-danger">*</span></label>
                                <select name="gender_id" id="edit_emp_gender_id" class="form-control select2" required>
                                    <option value="" disabled selected>-- {{ trans('admin.global.select') }} --</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.blood_type') }} <span class="text-danger">*</span></label>
                                <select name="blood_type_id" id="edit_emp_blood_type_id" class="form-control select2" required>
                                    <option value="" disabled selected>-- {{ trans('admin.global.select') }} --</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.nationality') }} <span class="text-danger">*</span></label>
                                <select name="nationality_id" id="edit_emp_nationality_id" class="form-control select2" required>
                                    <option value="" disabled selected>-- {{ trans('admin.global.select') }} --</option>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.religion') }} <span class="text-danger">*</span></label>
                                <select name="religion_id" id="edit_emp_religion_id" class="form-control select2" required>
                                    <option value="" disabled selected>-- {{ trans('admin.global.select') }} --</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="specialization_id" id="edit_emp_specialization_id" class="form-control select2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.joining_date') }} <span class="text-danger">*</span></label>
                                <input class="form-control edit-emp-fc-datepicker" id="edit_emp_joining_date" placeholder="YYYY-MM-DD"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control numeric-only" name="phone" id="edit_emp_phone"
                                       maxlength="20">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="edit_emp_address" class="form-control" maxlength="500">
                                <span class="text-danger error-text address_error"></span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.status') }} <span class="text-danger">*</span></label>
                    ...
                    <!-- Attachments -->
                    <h6 class="mb-3 mt-4 text-primary"><i class="fas fa-paperclip"></i> {{ trans('admin.employees.fields.attachments') }}</h6>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('admin.employees.fields.image') }}</label>
                                <input type="file" class="form-control" name="image" id="employee_image_edit" accept="image/*">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="attachments[]" id="employee_attachments_edit" multiple>
