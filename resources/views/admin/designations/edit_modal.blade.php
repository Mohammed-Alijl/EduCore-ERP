                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.designations.fields.name') }} <span class="text-danger">*</span></label>
                                <input type="text" name="name" id="edit_name" class="form-control"
                                       placeholder="{{ __('admin.designations.fields.name') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.designations.fields.department') }} <span class="text-danger">*</span></label>
                                <select name="department_id" id="edit_department_id" class="form-control" required>
                                    <option value="">{{ __('admin.designations.select_department') }}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.designations.fields.default_salary') }}</label>
                                <input type="number" name="default_salary" id="edit_default_salary" class="form-control"
                                       placeholder="{{ __('admin.designations.fields.default_salary') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.designations.fields.can_teach') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ __('admin.designations.fields.description') }}</label>
                                <textarea name="description" id="edit_description" class="form-control" rows="3"
                                          placeholder="{{ __('admin.designations.fields.description') }}"
