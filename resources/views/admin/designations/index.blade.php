                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-md-nowrap" id="designations_table">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">{{ __('admin.designations.fields.department') }}</th>
                                <th class="wd-15p border-bottom-0">{{ __('admin.designations.fields.description') }}</th>
                                <th class="wd-10p border-bottom-0 text-center">{{ __('admin.designations.fields.default_salary') }}</th>
                                <th class="wd-8p border-bottom-0 text-center">{{ __('admin.designations.fields.can_teach') }}</th>
                                <th class="wd-8p border-bottom-0 text-center">{{ __('admin.designations.fields.employees_count') }}</th>
                                @canany(['edit_designation','delete_designation','view_designation'])
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="desig-department-badge">
                                            <i class="las la-building"></i> {{ $designation->department->name ?? '--' }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="desig-description-cell d-inline-block">{{ $designation->description ?: __('admin.designations.no_description') }}</span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @if($designation->can_teach)
                                            <span class="desig-teach-badge badge-yes">{{ __('admin.global.yes') }}</span>
                                        @else
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-outline-primary btn-sm desig-action-btn desig-show-btn"
                                           href="#"
                                           data-toggle="modal"
                                           data-target="#showDesignationModal"
                                        ...
                                        <a class="btn btn-outline-info btn-sm desig-action-btn edit-btn"
                                           href="#"
                                           data-toggle="modal"
