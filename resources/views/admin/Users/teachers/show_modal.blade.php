    ...
    <div class="modal-dialog modal-lg text-center" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header d-flex justify-content-between">
                <h6 class="modal-title font-weight-bold"><i class="fas fa-id-badge text-primary mr-1"></i> {{ trans('admin.Users.teachers.show') }}</h6>
            ...
            <div class="modal-body p-4 text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                ...
                <div class="card user-info-card shadow-sm mb-4 border-0 rounded-lg">
                    <div class="card-body p-3 d-flex align-items-center rounded-lg">
                        ...
                        <div>
                            ...
                            <p id="show_teacher_code" class="text-muted mb-0 font-weight-semibold"><i class="fas fa-barcode"></i> {{ trans('admin.Users.teachers.fields.teacher_code') }}: <span></span></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <h6 class="teacher-section-heading"><i class="fas fa-address-book mx-1"></i> {{ trans('admin.Users.teachers.contact_info') }}</h6>
                        <ul class="list-unstyled mb-0 list-item-spacing">
                            <li class="mb-2 d-flex align-items-center">
                                ...
                                <div><small class="text-muted d-block">{{ trans('admin.Users.teachers.fields.email') }}</small> <span id="show_email" class="font-weight-semibold"></span></div>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <div class="icon-circle bg-info-transparent text-info mx-3"><i class="fas fa-phone"></i></div>
                                <div><small class="text-muted d-block">{{ trans('admin.Users.teachers.fields.phone') }}</small> <span id="show_phone" class="font-weight-semibold"></span></div>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <div class="icon-circle bg-secondary-transparent text-secondary mx-3"><i class="fas fa-map-marker-alt"></i></div>
                                <div><small class="text-muted d-block">{{ trans('admin.Users.teachers.fields.address') }}</small> <span id="show_address" class="font-weight-semibold"></span></div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- Personal Info -->
                    <div class="col-md-6 mb-4">
                        <h6 class="teacher-section-heading"><i class="fas fa-user-circle mx-1"></i> {{ trans('admin.Users.teachers.teacher_information') }}</h6>
                        <ul class="list-unstyled mb-0 list-item-spacing">
                            <li class="mb-2 d-flex align-items-center">
                                <div class="icon-circle bg-warning-transparent text-warning mx-3"><i class="fas fa-id-card"></i></div>
                                <div><small class="text-muted d-block">{{ trans('admin.Users.teachers.fields.national_id') }}</small> <span id="show_national_id" class="font-weight-semibold"></span></div>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <div class="icon-circle bg-success-transparent text-success mx-3"><i class="fas fa-calendar-alt"></i></div>
                                <div><small class="text-muted d-block">{{ trans('admin.Users.teachers.fields.joining_date') }}</small> <span id="show_joining_date" class="font-weight-semibold"></span></div>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <div class="icon-circle bg-danger-transparent text-danger mx-3"><i class="fas fa-venus-mars"></i></div>
                                <div><small class="text-muted d-block">{{ trans('admin.Users.teachers.fields.gender') }}</small> <span id="show_gender" class="font-weight-semibold"></span></div>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <h6 class="teacher-section-heading"><i class="fas fa-globe mx-1"></i> {{ trans('admin.Users.teachers.details') }}</h6>
                        <div class="row text-center teacher-details-grid p-3 m-0 shadow-sm">
                            ...
                            <div class="col-3 {{ app()->getLocale() == 'ar' ? 'border-left' : 'border-right' }}">
                                <small class="text-muted d-block mb-1">{{ trans('admin.Users.teachers.fields.nationality') }}</small>
                                <span id="show_nationality" class="font-weight-bold text-dark"></span>
                            </div>
                            <div class="col-3 {{ app()->getLocale() == 'ar' ? 'border-left' : 'border-right' }}">
                                <small class="text-muted d-block mb-1">{{ trans('admin.Users.teachers.fields.religion') }}</small>
                                <span id="show_religion" class="font-weight-bold text-dark"></span>
                            </div>
                            <div class="col-3">
                                <small class="text-muted d-block mb-1">{{ trans('admin.Users.teachers.fields.blood_type') }}</small>
                ...
                <div class="row" id="show_attachments_container" style="display: none;">
                    <div class="col-12">
                        <h6 class="text-primary font-weight-bold mb-3 border-bottom pb-2"><i class="fas fa-paperclip mx-1"></i> {{ trans('admin.Users.teachers.fields.attachments') }}</h6>
