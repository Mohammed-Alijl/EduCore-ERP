...
@section('title', __('admin.Users.teachers.archived'))
...
@section('page-header')
    <div class="teacher-archive-header d-flex justify-content-between align-items-center mt-4 mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h4 class="mb-1 text-white font-weight-bold">{{ __('admin.Users.teachers.archived') }}</h4>
                <p class="mb-0 text-white-50 tx-13">{{ __('admin.Users.teachers.archived_list') ?? __('admin.global.archived_list') }}</p>
            </div>
        </div>
        <div>
            <a href="{{ route('admin.Users.teachers.index') }}" class="btn btn-light shadow-sm" style="border-radius: 8px; font-weight: 600;">
...
@section('content')
    ...
    <div class="teacher-archive-alert shadow-sm">
        ...
        <div>
            <h6 class="text-danger font-weight-bold mb-1">{{ trans('admin.Users.teachers.warning_title') ?? trans('admin.global.warning') }}</h6>
            <p class="text-muted mb-0 tx-13">{{ trans('admin.Users.teachers.warning_body') ?? trans('admin.global.archive_warning') }}</p>
        </div>
    </div>
            ...
            <div class="card teacher-glass-card-archive">
                <div class="archive-table-card-header pb-0">
                    <div class="archive-table-title">
                        ...
                        {{ __('admin.Users.teachers.archived') }}
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="teachers_table">
                            ...
                            <tr>
                                ...
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.teachers.fields.teacher_code') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.teachers.fields.name') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.teachers.fields.email') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.teachers.fields.national_id') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.teachers.fields.phone') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.teachers.fields.status') }}</th>
                                            ...
                                            <div class="teacher-actions-container">
                                                @can('restore_teachers')
                                                    <a class="btn btn-sm btn-teacher-restore restore-item"
                                                       href="#"
                                                       data-url="{{ route('admin.Users.teachers.restore', $teacher->id) }}"
                                                       data-id="{{ $teacher->id }}"
                                                ...
                                                @can('force-delete_teachers')
                                                    <a class="btn btn-sm btn-teacher-delete delete-item"
                                                       href="#"
                                                       data-id="{{ $teacher->id }}"
                                                       data-url="{{ route('admin.Users.teachers.forceDelete', $teacher->id) }}"
                                                       data-name="{{ $teacher->name }}">
...
@section('js')
    ...
    @include('admin.Users.teachers.show_modal')
