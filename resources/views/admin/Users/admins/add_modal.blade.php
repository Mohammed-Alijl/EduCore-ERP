    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title"><i class="fas fa-plus-circle mr-1 ml-1"></i> {{ __('admin.Users.admins.add') }}</h6>
                <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>

            <form action="{{ route('admin.Users.admins.store') }}"
                  method="post"
                  class="ajax-form"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Users.admins.fields.password') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Users.admins.fields.confirm_password') }} <span class="text-danger">*</span></label>
