...
@section('title', __('admin.Users.guardians.title'))
...
@section('css')
    ...
    <link href="{{ URL::asset('assets/admin/css/Users/guardian/guardian-crud.css') }}" rel="stylesheet" />
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.Users.guardians.title') }}</span>
            </div>
        </div>
            ...
            @can('view-archived_guardians')
                <div class="pr-1 mb-3 mb-xl-0">
                    <a class="modal-effect btn btn-danger btn-with-icon btn-block"
                       href="{{route('admin.Users.guardians.archived')}}">
                        <i class="fas fa-book ml-2"></i>  {{__('admin.Users.guardians.archived') }}
                    </a>
                </div>
            @endcan
            @can('create_guardians')
                <div class="pr-1 mb-3 mb-xl-0">
                    <a class="modal-effect btn btn-primary btn-with-icon btn-block"
                       ...
                       data-toggle="modal"
                       href="#addModal">
                        <i class="fas fa-user-plus ml-2"></i> {{ __('admin.Users.guardians.add') }}
                    </a>
                </div>
            @endcan
        </div>
...
@section('content')
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card guardian-glass-card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="guardian-actions-container">
                                            @can('edit_guardians')
                                                <a class="btn-guardian-edit edit-btn"
                                                   href="#"
                                                   data-toggle="modal"
                                                   data-target="#editModal"
                                                   data-url="{{ route('admin.Users.guardians.update', $guardian->id) }}"
                                                   data-id="{{ $guardian->id }}"
                                                   data-email="{{ $guardian->email }}"
                                                   data-name_father_ar="{{ $guardian->getTranslation('name_father', 'ar') }}"
                                                   data-name_father_en="{{ $guardian->getTranslation('name_father', 'en') }}"
                                            ...
                                            @can('delete_guardians')
                                                <a class="modal-effect btn-guardian-archive delete-item"
                                                   href="#"
                                                   data-id="{{ $guardian->id }}"
                                                   data-url="{{ route('admin.Users.guardians.destroy', $guardian->id) }}">
    ...
    @include('admin.Users.guardians.add_modal')
    @include('admin.Users.guardians.edit_modal')
