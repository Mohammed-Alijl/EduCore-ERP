        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editGuardianModalLabel">
                    <i class="fas fa-user-edit"></i> {{ trans('admin.Users.guardians.edit') }}
                </h5>
                    ...
                    <div id="editGuardianWizard">
                        ...
                        <section>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ trans('admin.Users.guardians.fields.password') }}</label>
                                        <input type="password" class="form-control" name="password" id="edit_password" minlength="8" maxlength="30" data-parsley-group="edit-step-3" placeholder="{{ __('admin.Users.guardians.fields.password') }}">
                                        <span class="text-danger error-text password_error"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ trans('admin.Users.guardians.fields.password_confirmation') }}</label>
                                        <input type="password" name="password_confirmation" id="edit_password_confirmation" class="form-control" data-parsley-equalto="#edit_password" data-parsley-group="edit-step-3" placeholder="{{ __('admin.Users.guardians.fields.password_confirmation') }}">
