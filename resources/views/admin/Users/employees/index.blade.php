...
@section('title', trans('admin.Users.employees.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('admin.Users.employees.title') }}</span>
            </div>
        </div>
            ...
            @can('view-archived_employees')
                 <div class="pr-1 mb-3 mb-xl-0">
                    <a class="modal-effect btn btn-danger btn-with-icon btn-block"
                       href="{{route('admin.Users.employees.archived')}}">
                        <i class="fas fa-book ml-2"></i>  {{trans('admin.Users.employees.archived') }}
                    </a>
            </div>
            @endcan
            @can('create_employees')
                ...
                <a class="modal-effect btn btn-primary btn-with-icon btn-block"
                   ...
                   href="#addEmployeeModal">
                    <i class="fas fa-plus-circle ml-2"></i> {{ trans('admin.Users.employees.add') }}
                </a>
            </div>
            @endcan
        </div>
...
@section('content')
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            <i class="las la-building mr-1"></i> {{ trans('admin.HR.departments.title') }}
                        </label>
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            <i class="las la-id-badge mr-1"></i> {{ trans('admin.HR.designations.title') }}
                        </label>
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            <i class="las la-toggle-on mr-1"></i> {{ trans('admin.Users.employees.fields.status') }}
                        </label>
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="employees_table">
                            ...
                            <tr>
                                ...
                                <th class="wd-5p border-bottom-0">{{ trans('admin.Users.employees.fields.image') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.employee_code') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.designation') }}</th>
                                <th class="wd-15p border-bottom-0">{{ trans('admin.Users.employees.fields.name') }}</th>
                                <th class="wd-15p border-bottom-0">{{ trans('admin.Users.employees.fields.email') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.phone') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.status') }}</th>
    ...
    @include('admin.Users.employees.add_modal')
    @include('admin.Users.employees.edit_modal')
    @include('admin.Users.employees.show_modal')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#employees_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.Users.employees.index') }}",
                    data: function(d) {
