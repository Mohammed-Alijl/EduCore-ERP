    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ trans('admin.Users.employees.edit') }}</h6>
            ...
            <form action="" method="POST" class="ajax-form" data-modal-id="#editEmployeeModal"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.password') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.password_confirmation') }}</label>
