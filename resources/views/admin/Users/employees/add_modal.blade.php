    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ trans('admin.Users.employees.add') }}</h6>
                <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('admin.Users.employees.store') }}" method="POST" class="ajax-form"
                data-modal-id="#addEmployeeModal" enctype="multipart/form-data" data-parsley-validate="">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <h6 class="mb-3 text-primary"><i class="fas fa-user-tie"></i>
                        {{ trans('admin.Users.employees.employee_information') }}</h6>

                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.name_ar') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="name[ar]" class="form-control"
                                    placeholder="{{ trans('admin.Users.employees.fields.name_ar') }}" required minlength="3"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.name_en') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="name[en]" class="form-control"
                                    placeholder="{{ trans('admin.Users.employees.fields.name_en') }}" required minlength="3"
                                    maxlength="100" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.email') }} <span
                                        class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="email" placeholder="employee@edu.com"
                                    required minlength="5" maxlength="100" autocomplete="off">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.national_id') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.phone') }}</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.gender') }} <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.password') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.password_confirmation') }} <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.nationality') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.religion') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.blood_type') }} <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.department') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.designation') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.HR.specializations.title') ?? 'Specialization' }}</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.joining_date') }} <span
                                        class="text-danger">*</span></label>
                                <input class="form-control emp-fc-datepicker" placeholder="YYYY-MM-DD" type="text"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.contract_type') }} <span
                                        class="text-danger">*</span></label>
                                <select name="contract_type" class="form-control select2" required>
                                    <option value="" disabled selected>-- {{ trans('admin.global.select') }} --
                                    </option>
                                    <option value="full_time">{{ trans('admin.Users.employees.contract_types.full_time') }}
                                    </option>
                                    <option value="part_time">{{ trans('admin.Users.employees.contract_types.part_time') }}
                                    </option>
                                    <option value="contract">{{ trans('admin.Users.employees.contract_types.contract') }}
                                    </option>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.basic_salary') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.bank_account_number') }}</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.status') }} <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.address') }}</label>
                    ...
                    <h6 class="mb-3 mt-4 text-primary"><i class="fas fa-paperclip"></i>
                        {{ trans('admin.Users.employees.fields.attachments') }}</h6>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.image') }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('admin.Users.employees.fields.attachments') }}</label>
                                <input type="file" class="form-control" name="attachments[]"
                                    id="employee_attachments" multiple>
    ...
    <script>
        $(function() {
            ...
            function initFileInputs() {
                ...
                if (!$('#employee_image').data('fileinput')) {
                ...
                if (!$('#employee_attachments').data('fileinput')) {

                    $('#employee_attachments').fileinput({
                        theme: 'fa5',
                        language: '{{ app()->getLocale() }}',
            ...
            function clearFileInputs() {
                ...
                if ($('#employee_image').data('fileinput')) {
                    $('#employee_image').fileinput('clear');
                }

                if ($('#employee_attachments').data('fileinput')) {
                    $('#employee_attachments').fileinput('clear');
                }
            ...
            $('#emp_department_id').on('change', function() {
                ...
                if (department_id) {
                    $.ajax({
                        url: "{{ route('admin.HR.designations.get_designations') }}",
                        type: "GET",
            ...
            /* Telephone Input */
            if ($("#emp_phone").length) {
                var input = document.querySelector("#emp_phone");
