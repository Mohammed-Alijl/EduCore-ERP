...
@section('title', __('admin.Users.employees.archived'))
...
@section('page-header')
    <div class="teacher-archive-header d-flex justify-content-between align-items-center mt-4 mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h4 class="mb-1 text-white font-weight-bold">{{ __('admin.Users.employees.archived') }}</h4>
                <p class="mb-0 text-white-50 tx-13">{{ __('admin.Users.employees.archived_list') ?? __('admin.global.archived_list') }}</p>
            </div>
        </div>
        <div>
            <a href="{{ route('admin.Users.employees.index') }}" class="btn btn-light shadow-sm" style="border-radius: 8px; font-weight: 600;">
...
@section('content')
    ...
    <div class="teacher-archive-alert shadow-sm">
        ...
        <div>
            <h6 class="text-danger font-weight-bold mb-1">{{ trans('admin.Users.employees.warning_title') ?? trans('admin.global.warning') }}</h6>
            <p class="text-muted mb-0 tx-13">{{ trans('admin.Users.employees.warning_body') ?? trans('admin.global.archive_warning') }}</p>
        </div>
    </div>
            ...
            <div class="card teacher-glass-card-archive">
                <div class="archive-table-card-header pb-0">
                    <div class="archive-table-title">
                        ...
                        {{ __('admin.Users.employees.archived') }}
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="employees_archive_table">
                            ...
                            <tr>
                                ...
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.type') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.name') }}</th>
                                <th class="wd-10p border-bottom-0">{{ trans('admin.Users.employees.fields.email') }}</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#employees_archive_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.Users.employees.archived') }}",
                },
                columns: [
