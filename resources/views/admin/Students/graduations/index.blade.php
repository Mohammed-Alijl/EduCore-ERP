...
@section('title', trans('admin.Students.graduations.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="content-title mb-0 my-auto font-weight-bold">{{ trans('admin.Students.graduations.title') }}</h4>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div class="mb-3 mb-xl-0 ml-2">
                <a class="btn btn-modern btn-primary shadow-sm" href="{{ route('admin.Users.students.index') }}">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <label class="form-label tx-11 font-weight-bold text-uppercase text-muted">
                            ...
                            {{ trans('admin.Students.graduations.fields.graduation_year') }}
                        </label>
                ...
                <div class="card-header pb-0 border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="card-title mb-0 d-flex align-items-center">
                            ...
                            {{ trans('admin.Students.graduations.list_title') }}
                        </h6>
                        ...
                        <table class="table table-hover text-md-nowrap" id="graduations_table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-12p border-bottom-0">{{ trans('admin.Users.students.fields.student_code') }}
                                    </th>
                                    <th class="wd-18p border-bottom-0">{{ trans('admin.Users.students.fields.name') }}</th>
                                    <th class="wd-25p border-bottom-0">{{ trans('admin.Students.graduations.fields.last_grade') }}
                                    </th>
                                    <th class="wd-15p border-bottom-0">
                                        {{ trans('admin.Students.graduations.fields.graduation_year') }}</th>
                                    <th class="wd-12p border-bottom-0">{{ trans('admin.Students.graduations.fields.graduated_at') }}
                                    </th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#graduations_table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.Students.graduations.index') }}",
                    data: function(d) {
