                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h3 class="att-section-title mb-0">
                            {{ trans('admin.reports.attendance.table.title') }}
                        </h3>
                        <p class="att-section-subtitle mb-0">
                            {{ trans('admin.reports.attendance.table.subtitle') }}
                        </p>
                    </div>
                    <div class="mt-3 mt-md-0">
                        <span class="badge badge-primary"
                            ...
                            {{ trans('admin.reports.attendance.table.records') }}
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    ...
                                    {{ trans('admin.reports.attendance.table.student_name') }}
                                </th>
                                <th>
                                    <i class="las la-users mr-1 ml-1"></i>
                                    {{ trans('admin.reports.attendance.table.section') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-calendar mr-1 ml-1"></i>
                                    {{ trans('admin.reports.attendance.table.total_days') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-check-circle mr-1 ml-1"></i>
                                    {{ trans('admin.reports.attendance.table.present') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-times-circle mr-1 ml-1"></i>
                                    {{ trans('admin.reports.attendance.table.absent') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-clock mr-1 ml-1"></i>
                                    {{ trans('admin.reports.attendance.table.late') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-percentage mr-1 ml-1"></i>
                                    {{ trans('admin.reports.attendance.table.percentage') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
