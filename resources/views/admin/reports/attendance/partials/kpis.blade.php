                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="att-kpi-label">
                            {{ trans('admin.reports.attendance.kpis.absent_today') }}
                        </div>
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.reports.attendance.kpis.absent_today_hint') }}
                            </span>
                        </div>
                    </div>
        ...
        <div class="att-kpi-card emerald">
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="att-kpi-label">
                            {{ trans('admin.reports.attendance.kpis.average_attendance') }}
                        </div>
                        <div class="att-kpi-value mt-2">
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.reports.attendance.kpis.average_attendance_hint') }}
                            </span>
                        </div>
                    </div>
                    <div class="att-kpi-icon-wrapper">
        ...
        <div class="att-kpi-card amber">
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="att-kpi-label">
                            {{ trans('admin.reports.attendance.kpis.at_risk') }}
                        </div>
                        <div class="att-kpi-value mt-2">
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.reports.attendance.kpis.at_risk_hint') }}
                            </span>
                        </div>
                    </div>
                    <div class="att-kpi-icon-wrapper">
