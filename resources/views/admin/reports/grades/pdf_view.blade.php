...
<body>
    <div class="pdf-container">
        ...
        <div class="pdf-header">
            ...
            <p>{{ trans('admin.reports.grades.table.records') }}: {{ number_format($records->count()) }}</p>
        </div>
        ...
        <div class="kpi-grid">
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.reports.grades.kpis.total_students') }}</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.reports.grades.kpis.average_percentage') }}</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.reports.grades.kpis.pass_rate') }}</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.reports.grades.kpis.total_exams') }}</div>
            </div>
        </div>
        ...
        @if ($chartData)
            ...
            <div class="chart-grid">
                ...
                <div class="chart-container">
                    <div class="chart-title">{{ trans('admin.reports.grades.charts.score_distribution') }}</div>
                    <div id="scoreDistributionChart"></div>
                </div>

                <!-- Subject Performance Chart -->
                <div class="chart-container">
                    <div class="chart-title">{{ trans('admin.reports.grades.charts.subject_performance') }}</div>
                    <div id="subjectPerformanceChart"></div>
                </div>

                <!-- Grade Comparison Chart -->
                <div class="chart-container">
                    <div class="chart-title">{{ trans('admin.reports.grades.charts.grade_comparison') }}</div>
        ...
        <div class="table-container">
            <div class="table-header">{{ trans('admin.reports.grades.table.title') }}</div>
            <table>
                <thead>
                    <tr>
                        <th>#</th>
        ...
        <div class="pdf-footer">
            <p>{{ trans('admin.exports.auto_generated') }}</p>
    ...
    @if ($chartData)
        <script>
            ...
            const scoreDistributionOptions = {
                series: [{
                    name: '{{ trans('admin.reports.grades.charts.students') }}',
            ...
            const subjectPerformanceOptions = {
                series: [{
                    name: '{{ trans('admin.reports.grades.charts.average_percentage') }}',
            ...
            const gradeComparisonOptions = {
                series: [{
                    ...
                    name: '{{ trans('admin.reports.grades.charts.pass_rate') }}',
