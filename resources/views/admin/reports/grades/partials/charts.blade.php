        ...
        <div class="card grades-chart-card">
            <div class="card-body p-4">
                <h5 style="font-weight: 700; color: #6366f1; margin-bottom: 1rem;">
                    ...
                    {{ trans('admin.reports.grades.charts.score_distribution') }}
                </h5>
        ...
        <div class="card grades-chart-card">
            <div class="card-body p-4">
                <h5 style="font-weight: 700; color: #6366f1; margin-bottom: 1rem;">
                    ...
                    {{ trans('admin.reports.grades.charts.subject_performance') }}
                </h5>
        ...
        <div class="card grades-chart-card">
            <div class="card-body p-4">
                <h5 style="font-weight: 700; color: #6366f1; margin-bottom: 1rem;">
                    ...
                    {{ trans('admin.reports.grades.charts.grade_comparison') }}
                </h5>
