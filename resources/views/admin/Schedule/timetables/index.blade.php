...
@section('title', __('admin.Schedule.timetables.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="content-title mb-0 my-auto font-weight-bold">{{ __('admin.Schedule.timetables.title') }}</h4>
                    <span class="text-muted mt-1 tx-13 d-block">{{ __('admin.Schedule.timetables.subtitle') }}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row row-sm">
            <div class="col-xl-12">
                    ...
                    <div class="glass-card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-title-text">
                                <h5>{{ __('admin.Schedule.timetables.select_section') }}</h5>
                                <span>{{ __('admin.Schedule.timetables.select_section_subtitle') }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-layer-group"></i> {{ __('admin.Academic.grades.select') }}
                                </label>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-school"></i> {{ __('admin.Academic.classrooms.select') }}
                                </label>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-users"></i> {{ __('admin.Academic.sections.select') }}
                                </label>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <button id="load_timetable"
                                    ...
                                    <span>{{ __('admin.Schedule.timetables.load_timetable') }}</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card-header">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-title-text">
                                    <h5 id="section_title">{{ __('admin.Schedule.timetables.weekly_schedule') }}</h5>
                    ...
                    <div class="glass-card-body">
                        <div class="table-responsive">
                            <table class="table timetable-matrix">
                                <thead>
                                    <tr>
                                        <th>{{ __('admin.Schedule.timetables.period') }}</th>
                ...
                <div class="timetable-empty-state" id="empty_state">
                    ...
                    <h4>{{ __('admin.Schedule.timetables.no_timetable') }}</h4>
                    <p>{{ __('admin.Schedule.timetables.select_section_to_view') }}</p>
                </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    error: function() {
                        $('#empty_state').html(`
                            ...
                            <h4 class="text-danger">{{ __('admin.Schedule.timetables.errors.fetch_failed') }}</h4>
                        `);
                    }
                });
            }
            ...
            function renderMatrix(data) {
                ...
                $('#section_subtitle').text('{{ __('admin.Schedule.timetables.weekly_schedule') }}');
                ...
                data.periods.forEach(period => {
                    ...
                    if (period.is_break) {
                        ...
                        bodyHtml += `<td colspan="${data.days.length}" class="break-period text-center">
                            <em><i class="las la-coffee mr-2"></i>{{ __('admin.Schedule.timetables.break_time') }}</em>
                        </td>`;
                    } else {
                            ...
                            if (slot) {
                                ...
                                @can('create_timetables')
                                    bodyHtml += `<button class="assign-slot">
                                        ...
                                        <span>{{ __('admin.Schedule.timetables.assign') }}</span>
                                    </button>`;
                                @else
            ...
            window.openAssignModal = function(dayId, periodId, slotId, subjectId, teacherId) {
                ...
                if (slotId) {
                    $('#assign_modal_title').text('{{ __('admin.Schedule.timetables.edit_assignment') }}');
                    // Load existing slot data would go here
                } else {
                    $('#assign_modal_title').text('{{ __('admin.Schedule.timetables.create_assignment') }}');
                    resetAssignForm();
                }
            ...
            function deleteSlot(slotId) {
                swal({
                    ...
                    text: "{{ __('admin.Schedule.timetables.delete_confirm') }}",
                    type: "warning",
                    ...
                    $.ajax({
                        ...
                        error: function() {
                            swal("{{ __('admin.global.error_title') }}",
                                "{{ __('admin.Schedule.timetables.errors.delete_failed') }}",
                                "error");
                        }
                    });
                });
