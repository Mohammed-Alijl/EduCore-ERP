    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="assign_modal_title">{{ __('admin.Schedule.timetables.create_assignment') }}
                </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mt-3 d-none" id="assignment_info">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <strong>{{ __('admin.Schedule.timetables.assignment_details') }}</strong>
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (window.loadTimetableMatrix) {
                                window.loadTimetableMatrix(currentSectionId,
                        ...
                        if (xhr.status === 422) {
                            ...
                            swal({
                                ...
                                text: xhr.responseJSON.message ||
                                    "{{ __('admin.Schedule.timetables.errors.save_failed') }}",
                                type: "error"
                            });
                        } else {
                            swal({
                                title: "{{ __('admin.global.error_title') }}",
                                text: "{{ __('admin.Schedule.timetables.errors.save_failed') }}",
                                type: "error"
                            });
                        }
                    },
