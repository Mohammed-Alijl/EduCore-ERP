...
@section('title', __('admin.Schedule.class_periods.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="content-title mb-0 my-auto font-weight-bold">{{ __('admin.Schedule.class_periods.title') }}</h4>
                    <span class="text-muted mt-1 tx-13 d-block">{{ __('admin.Schedule.class_periods.subtitle') }}</span>
                </div>
            </div>
        </div>
            ...
            @can('create_classPeriods')
                <div class="mb-3 mb-xl-0 ml-2">
                    <a class="modal-effect btn btn-primary btn-with-icon btn-block" data-effect="effect-scale"
                        ...
                        <i class="fas fa-plus-circle"></i> {{ __('admin.Schedule.class_periods.add') }}
                    </a>
                </div>
            @endcan
        </div>
                    ...
                    <div class="glass-card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-title-text">
                                <h5>{{ __('admin.Schedule.class_periods.filters.title') }}</h5>
                                <span>{{ __('admin.Schedule.class_periods.filters.subtitle') }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-layer-group"></i> {{ __('admin.Schedule.class_periods.filters.grade') }}
                                </label>
                            ...
                            <div class="col-lg-4 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-tags"></i> {{ __('admin.Schedule.class_periods.filters.type') }}
                                </label>
                                <select class="form-control form-control-modern select2" id="filter_is_break"
                                    name="is_break">
                                    <option value="">{{ __('admin.global.all') }}</option>
                                    <option value="0">{{ __('admin.Schedule.class_periods.class') }}</option>
                                    <option value="1">{{ __('admin.Schedule.class_periods.break') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-toggle-on"></i> {{ __('admin.Schedule.class_periods.filters.status') }}
                                </label>
                ...
                <div class="glass-card">
                    <div class="glass-card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-title-text">
                                <h5>{{ __('admin.Schedule.class_periods.table.title') }}</h5>
                                <span>{{ __('admin.Schedule.class_periods.table.subtitle') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="glass-card-body">
                            ...
                            <table class="table text-md-nowrap" id="class_periods_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-20p border-bottom-0">{{ __('admin.Schedule.class_periods.fields.name') }}</th>
                                        <th class="wd-12p border-bottom-0">{{ __('admin.Schedule.class_periods.fields.grade') }}
                                        </th>
                                        <th class="wd-18p border-bottom-0">
                                            {{ __('admin.Schedule.class_periods.fields.time_range') }}</th>
                                        <th class="wd-10p border-bottom-0 text-center">
                                            {{ __('admin.Schedule.class_periods.fields.duration') }}</th>
                                        <th class="wd-10p border-bottom-0 text-center">
                                            {{ __('admin.Schedule.class_periods.fields.type') }}</th>
                                        <th class="wd-10p border-bottom-0 text-center">
                                            {{ __('admin.Schedule.class_periods.fields.status') }}</th>
