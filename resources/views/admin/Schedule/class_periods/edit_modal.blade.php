        ...
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">
                    ...
                    {{ __('admin.Schedule.class_periods.edit') }}
                </h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.name_en') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="name[en]" id="edit_name_en" class="form-control"
                                    placeholder="{{ __('admin.Schedule.class_periods.fields.name_en') }}" required minlength="2"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.name_ar') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="name[ar]" id="edit_name_ar" class="form-control"
                                    placeholder="{{ __('admin.Schedule.class_periods.fields.name_ar') }}" required minlength="2"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.grade') }}</label>
                                <select name="grade_id" id="edit_grade_id" class="form-control select2-modal-edit">
                                    <option value="">{{ __('admin.Schedule.class_periods.all_grades') }}</option>
                                    @foreach ($grades as $grade)
                                        <option value="{{ $grade->id }}">{{ $grade->name }}</option>
                                    @endforeach
                                </select>
                                <small class="text-muted">{{ __('admin.Schedule.class_periods.grade_hint') }}</small>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.type') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.start_time') }} <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.duration') }} <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text">{{ __('admin.Schedule.class_periods.minutes') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.end_time') }} <span
                                        class="text-danger">*</span></label>
                                <input type="time" name="end_time" id="edit_end_time" class="form-control" required
                                    autocomplete="off">
                                <small class="text-muted">{{ __('admin.Schedule.class_periods.end_time_hint') }}</small>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.sort_order') }}</label>
                                <input type="number" name="sort_order" id="edit_sort_order" class="form-control"
                                    placeholder="1" min="0" autocomplete="off">
                                <small class="text-muted">{{ __('admin.Schedule.class_periods.sort_order_hint') }}</small>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ __('admin.Schedule.class_periods.fields.status') }} <span
                                        class="text-danger">*</span></label>
