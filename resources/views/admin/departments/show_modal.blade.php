    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content dept-show-modal-content">
            ...
            <div class="modal-body p-4">
                ...
                <!-- Description -->
                <div class="mb-4">
                    <h6 class="font-weight-bold tx-14 mb-2">{{ __('admin.departments.fields.description') }}</h6>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <div class="dept-stat-card">
                            ...
                            <div class="dept-stat-label">{{ __('admin.departments.fields.employees_count') }}</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="dept-stat-card">
                            <div class="dept-stat-value text-warning" id="show-designations-count">0</div>
                            <div class="dept-stat-label">{{ __('admin.departments.fields.designations_count') }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h6 class="font-weight-bold tx-14 mb-3 d-flex align-items-center">
                        <i class="las la-briefcase mr-1 ml-1 text-primary"></i> {{ __('admin.departments.designations_list') }}
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered mb-0" id="dept-designations-table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('admin.departments.fields.name') }}</th>
                                    <th>{{ __('admin.departments.fields.employees_count') }}</th>
                                </tr>
                            </thead>
                    ...
                    <div id="no-designations-empty-state" class="text-center p-4 d-none dept-show-empty-state rounded mt-2">
                        ...
                        <h6 class="text-muted mb-0">{{ __('admin.departments.no_designations') }}</h6>
                    </div>
                </div>
...
<script>
    $(document).on('click', '.show-btn', function () {
        ...
        $('#show-dept-meta').text('{{ __("admin.departments.title") }}');
        $('#show-description').text(btn.data('description') || '{{ __("admin.departments.no_description") }}');
