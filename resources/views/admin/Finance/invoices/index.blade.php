...
@section('js')
    ...
    <script>
        $(function() {
            var studentSearchUrl = '{{ route('admin.Users.students.search') }}';
            var classroomsByGradeUrl = '{{ route('admin.Academic.classrooms.by-grade') }}';
            var invoiceTableUrl = '{{ route('admin.Finance.invoices.datatable') }}';
