<div class="modal fade" id="activateGatewayModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.Finance.payment_gateways.activate') }}" method="POST" class="ajax-form"
                data-modal-id="#activateGatewayModal" data-parsley-validate="">
                @csrf
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="form-group finance-form-group mb-0">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="activate_status" name="status"
                                        class="custom-control-input" value="1" checked>
                                    <label class="custom-control-label" for="activate_status">
                    ...
                    <div id="activate_settings_container" class="d-none mt-3">
                        <hr>
                        <h6 class="font-weight-bold mb-3">
                            <i class="las la-cog mr-1"></i>
                            {{ trans('admin.Finance.payment_gateways.fields.settings') }}
                        </h6>
                        <div id="activate_settings_fields" class="row">
