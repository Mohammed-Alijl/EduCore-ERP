                    ...
                    <div class="pg-card__footer">
                        @can('edit_payment_gateways')
                            <label class="pg-toggle">
                                <input type="checkbox" class="pg-toggle__input toggle-status"
                                    ...
                                    data-url="{{ route('admin.Finance.payment_gateways.toggle-status', $gw['gateway']->id) }}"
                                    {{ $gw['status'] ? 'checked' : '' }}>
                        ...
                        @can('edit_payment_gateways')
                            <button class="pg-btn pg-btn--configure edit-btn"
                                data-url="{{ route('admin.Finance.payment_gateways.update', $gw['gateway']->id) }}"
                                data-code="{{ $gw['code'] }}"
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var settingsSchemaUrl = "{{ route('admin.Finance.payment_gateways.settings-schema') }}";
