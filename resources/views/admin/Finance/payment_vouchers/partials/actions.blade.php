<div class="d-flex align-items-center justify-content-center gap-1">
    @can('print_paymentVoucher')
        <a href="{{ route('admin.Finance.payment_vouchers.print', $voucher->id) }}" class="btn btn-info btn-sm"
    ...
    @can('delete_paymentVoucher')
        <a href="javascript:void(0)" class="btn btn-danger btn-sm delete-item" data-id="{{ $voucher->id }}"
            data-url="{{ route('admin.Finance.payment_vouchers.destroy', $voucher->id) }}"
