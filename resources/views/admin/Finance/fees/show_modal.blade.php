        ...
        <div class="modal-content finance-show-modal-content">
            ...
            <div class="modal-body p-4 text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                ...
                <div class="finance-banner mb-4 d-flex justify-content-between p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span id="fee_show_grade_pill" class="integration-pill mt-1"><i
                                    class="las la-graduation-cap"></i> <span
                                    id="fee_show_grade_pill_text">—</span></span>
                        </div>
                    </div>

                    <div
                        class="amount-display pr-3 pl-3 my-auto text-{{ app()->getLocale() == 'ar' ? 'left' : 'right' }}">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="finance-section-card p-3">
                            <h6 class="finance-section-title mb-3">
                                ...
                                {{ __('admin.Users.students.academic_information') }}
                            </h6>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="show-info-item d-flex align-items-center border-0">
                                        <div class="show-icon-circle ic-primary mr-3 ml-3"><i
                                                class="las la-calendar-alt"></i></div>
                                        <div>
                                            <small
                                                class="show-label d-block">{{ __('admin.Finance.fees.fields.academic_year') }}</small>
                                            <span id="fee_show_academic_year"
                                                class="show-value font-weight-semibold">—</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="show-info-item d-flex align-items-center border-0">
                                        <div class="show-icon-circle ic-success mr-3 ml-3"><i
                                                class="las la-layer-group"></i></div>
                                        <div>
                                            <small
                                                class="show-label d-block">{{ __('admin.Finance.fees.fields.grade') }}</small>
                                ...
                                <div class="col-md-4">
                                    <div class="show-info-item d-flex align-items-center border-0">
                                        <div class="show-icon-circle ic-warning mr-3 ml-3"><i
                                                class="las la-chalkboard"></i></div>
                                        <div>
                                            <small
                                                class="show-label d-block">{{ __('admin.Finance.fees.fields.classroom') }}</small>
                                            <span id="fee_show_classroom"
                                                class="show-value font-weight-semibold">—</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="finance-description-container p-3">
                    <h6 class="text-primary font-weight-bold mb-2"><i class="las la-file-alt mr-1 ml-1"></i>
                        {{ __('admin.Finance.fees.fields.description') }}</h6>
...
@push('scripts')
    <script>
        function resetFeeShowModal() {
            $('#fee_show_title, #fee_show_category, #fee_show_grade_pill_text, #fee_show_amount, #fee_show_academic_year, #fee_show_grade, #fee_show_classroom, #fee_show_description')
                .text('—');
        }
