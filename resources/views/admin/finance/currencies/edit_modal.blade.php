        ...
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">
                    ...
                    {{ trans('admin.finance.currencies.edit') }}
                </h6>
            ...
            <form action="" method="POST" class="ajax-form" data-modal-id="#editCurrencyModal"
                        ...
                        <div class="col-md-6">
                            <div class="form-group finance-form-group">
                                ...
                                <input type="number" name="exchange_rate" class="form-control form-control-modern"
                                    placeholder="1.0000" step="0.0001" min="0.0001" max="999999" required>
