        ...
        <div class="modal-content online-class-show-modal-content">
            ...
            <div class="modal-header online-class-show-modal-header border-0 pb-0">
                <h5 class="modal-title font-weight-bold d-flex align-items-center">
                    ...
                    {{ trans('admin.LMS.online_classes.show') }}
                </h5>
            ...
            <div class="modal-body p-4 text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                        ...
                        <div class="online-class-section-card p-3">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="show-info-item d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        <small class="show-label d-block">{{ trans('admin.LMS.online_classes.grade') }}</small>
                                ...
                                <li class="show-info-item d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        <small class="show-label d-block">{{ trans('admin.LMS.online_classes.classroom') }}</small>
                                ...
                                <li class="show-info-item d-flex align-items-center mb-0">
                                    ...
                                    <div>
                                        <small class="show-label d-block">{{ trans('admin.LMS.online_classes.section') }}</small>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="online-class-section-card p-3">
                            <h6 class="online-class-section-title mb-3">
                                ...
                                {{ trans('admin.LMS.online_classes.timing') }}
                            </h6>
                            <ul class="list-unstyled mb-0">
                                <li class="show-info-item d-flex align-items-center mb-2">
                                    <div class="show-icon-circle ic-success mr-3 ml-3"><i class="las la-calendar-check"></i></div>
                                    <div>
                                        <small class="show-label d-block">{{ trans('admin.LMS.online_classes.timing') }}</small>
                                ...
                                <li class="show-info-item d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        <small class="show-label d-block">{{ trans('admin.LMS.online_classes.minutes') }}</small>
                                ...
                                <li class="show-info-item d-flex align-items-center mb-0">
                                    ...
                                    <div>
                                        <small class="show-label d-block">{{ trans('admin.LMS.online_classes.academic_year') }}</small>
                ...
                <div class="join-link-container p-4 text-center">
                    <p class="text-muted mb-3"><i class="las la-link mr-1"></i> {{ trans('admin.LMS.online_classes.join_link') }}</p>
        ...
        $(document).on('click', '.online-class-show-btn', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#oc_show_duration').text(item.duration + ' {{ trans("admin.LMS.online_classes.minutes") }}' || '—');
                    ...
                    if (item.join_url) {
                        $('#oc_show_join_link').html(
                            ...
                            '{{ trans("admin.LMS.online_classes.join") }}' + 
                            '</a>'
                        );
                    }
                },
