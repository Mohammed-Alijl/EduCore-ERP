...
@section('title', trans('admin.LMS.online_classes.title'))
        ...
        <div class="my-auto">
            <div class="d-flex align-items-center">
                <h4 class="content-title mb-0 my-auto">
                    ...
                    {{ trans('admin.LMS.online_classes.title') }}
                </h4>
                <span class="text-muted mt-1 tx-13 mg-l-5">
                    / {{ trans('admin.LMS.online_classes.management') }}
                </span>
            </div>
        </div>
    </div>
...
@section('content')
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-lg col-md-6 col-sm-12 mg-b-10">
                                <label class="form-label tx-12 fw-semibold text-uppercase">
                                    {{ trans('admin.LMS.online_classes.academic_year') }}
                                </label>
                            ...
                            <div class="col-lg col-md-6 col-sm-12 mg-b-10">
                                <label class="form-label tx-12 fw-semibold text-uppercase">
                                    {{ trans('admin.LMS.online_classes.grade') }}
                                </label>
                            ...
                            <div class="col-lg col-md-6 col-sm-12 mg-b-10">
                                <label class="form-label tx-12 fw-semibold text-uppercase">
                                    {{ trans('admin.LMS.online_classes.classroom') }}
                                </label>
                            ...
                            <div class="col-lg col-md-6 col-sm-12 mg-b-10">
                                <label class="form-label tx-12 fw-semibold text-uppercase">
                                    {{ trans('admin.LMS.online_classes.section') }}
                                </label>
                            ...
                            <div class="col-lg col-md-6 col-sm-12 mg-b-10">
                                <label class="form-label tx-12 fw-semibold text-uppercase">
                                    {{ trans('admin.LMS.online_classes.teacher') }}
                                </label>
                        ...
                        <table id="online_classes_table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('admin.LMS.online_classes.academic_year') }}</th>
                                    <th>{{ trans('admin.LMS.online_classes.grade_info') }}</th>
                                    <th>{{ trans('admin.LMS.online_classes.teacher') }}</th>
                                    <th>{{ trans('admin.LMS.online_classes.subject') }}</th>
                                    <th>{{ trans('admin.LMS.online_classes.timing') }}</th>
                                    <th>{{ trans('admin.LMS.online_classes.integration') }}</th>
                                    <th class="text-center">{{ trans('admin.LMS.online_classes.join_link') }}</th>
                                    <th class="text-center">{{ trans('admin.LMS.online_classes.actions') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
    ...
    @include('admin.LMS.online_classes.show_modal')
    </div>
    </div>
    </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#online_classes_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.LMS.online_classes.datatable') }}',
                    data: function(d) {
