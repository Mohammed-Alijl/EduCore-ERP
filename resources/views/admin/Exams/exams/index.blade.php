...
@section('title', trans('admin.Exams.exams.title'))
    ...
    <div class="breadcrumb-header justify-content-between exam-page">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="content-title mb-0 my-auto font-weight-bold">{{ trans('admin.Exams.exams.title') }}</h4>
                    <span class="text-muted mt-1 tx-13 d-block">{{ trans('admin.Exams.exams.subtitle') }}</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="glass-card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-title-text">
                                <h5>{{ trans('admin.Exams.exams.filters.title') }}</h5>
                                <span>{{ trans('admin.Exams.exams.filters.subtitle') }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-calendar-alt"></i> {{ trans('admin.Exams.exams.filters.academic_year') }}
                                </label>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-layer-group"></i> {{ trans('admin.Exams.exams.filters.grade') }}
                                </label>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-chalkboard"></i> {{ trans('admin.Exams.exams.filters.classroom') }}
                                </label>
                                <select class="form-control form-control-modern select2" id="filter_classroom"
                                    name="classroom_id" disabled>
                                    <option value="">{{ trans('admin.Exams.exams.filters.select_classroom') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label class="filter-label">
                                    <i class="las la-users"></i> {{ trans('admin.Exams.exams.filters.section') }}
                                </label>
                                <select class="form-control form-control-modern select2" id="filter_section"
                                    name="section_id" disabled>
                                    <option value="">{{ trans('admin.Exams.exams.filters.select_section') }}</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="glass-card">
                    <div class="glass-card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-title-text">
                                <h5>{{ trans('admin.Exams.exams.table.title') }}</h5>
                                <span>{{ trans('admin.Exams.exams.table.subtitle') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="glass-card-body">
                            ...
                            <table class="table text-md-nowrap" id="exams_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-20p border-bottom-0">{{ trans('admin.Exams.exams.table.exam_title') }}</th>
                                        <th class="wd-10p border-bottom-0">{{ trans('admin.Exams.exams.table.academic_year') }}
                                        </th>
                                        <th class="wd-15p border-bottom-0">{{ trans('admin.Exams.exams.table.teacher') }}</th>
                                        <th class="wd-10p border-bottom-0">{{ trans('admin.Exams.exams.table.subject') }}</th>
                                        <th class="wd-15p border-bottom-0">{{ trans('admin.Exams.exams.table.time_window') }}
                                        </th>
                                        <th class="wd-10p border-bottom-0 text-center">
                                            {{ trans('admin.Exams.exams.table.status') }}</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var examsTable = $('#exams_table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.Exams.exams.datatable') }}",
                    data: function(d) {
