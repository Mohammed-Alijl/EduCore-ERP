        ...
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a
                        href="{{ route('admin.cms.legal.index') }}">{{ __('admin.cms.legal_title') }}</a></span>
            ...
            <div class="card cms-glass-card">
                <div class="cms-header">
                    <div class="cms-header-content">
                        ...
                        <p class="cms-header-subtitle">{{ __('admin.cms.legal_edit_desc') }}</p>
                    </div>
                ...
                <form id="legal-form" method="POST" action="{{ route('admin.cms.legal.update', $page) }}">
                    ...
                    <div class="cms-body">
                        ...
                        <div class="info-alert">
                            ...
                            <p>
                                <strong>{{ __('admin.cms.info') }}:</strong>
                                {{ __('admin.cms.legal_content_info') }}
                            </p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.cms.fields.title_en') }} <span
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.cms.fields.title_ar') }} <span
                                                class="text-danger">*</span></label>
                        ...
                        <div class="form-section">
                            ...
                            <div class="content-panel active" id="content-en-panel">
                                <label class="form-label">{{ __('admin.cms.fields.content_en') }}</label>
                                <p class="text-muted small mb-2">{{ __('admin.cms.legal_content_hint') }}</p>
                            ...
                            <div class="content-panel" id="content-ar-panel">
                                <label class="form-label">{{ __('admin.cms.fields.content_ar') }}</label>
                                <p class="text-muted small mb-2">{{ __('admin.cms.legal_content_hint') }}</p>
                                <div class="editor-wrapper">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('admin.cms.fields.meta_description') }}
                                            (EN)</label>
                                        <p class="text-muted small mb-2">{{ __('admin.cms.meta_desc_hint') }}</p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_published" class="form-control">
                                            <option value="1" {{ $page->is_published ? 'selected' : '' }}>
                                                {{ __('admin.cms.published') }}</option>
                                            <option value="0" {{ !$page->is_published ? 'selected' : '' }}>
                                                {{ __('admin.cms.draft') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
