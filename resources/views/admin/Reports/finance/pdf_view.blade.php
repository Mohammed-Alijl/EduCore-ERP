...
<body>
    <div class="pdf-container">
        ...
        <div class="pdf-header">
            ...
            <p>{{ trans('admin.Reports.reports.financial.table.records') }}: {{ number_format($records->count()) }}</p>
        </div>
        ...
        <div class="kpi-grid">
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.Reports.reports.financial.kpis.total_outstanding') }}</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.Reports.reports.financial.kpis.students_count') }}</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">{{ trans('admin.Reports.reports.financial.kpis.average_debt') }}</div>
            </div>
        </div>
        ...
        @if ($chartData)
            ...
            <div class="chart-grid">
                ...
                <div class="chart-container">
                    <div class="chart-title">{{ trans('admin.Reports.reports.financial.charts.revenue_trend') }}</div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="chart-container">
                        <div class="chart-title">{{ trans('admin.Reports.reports.financial.charts.student_distribution') }}</div>
                        <div id="studentDistributionChart"></div>
                    </div>
    
                    <!-- Payment Timeline Chart -->
                    <div class="chart-container">
                        <div class="chart-title">{{ trans('admin.Reports.reports.financial.charts.payment_timeline') }}</div>
        ...
        <div class="table-container">
            <div class="table-header">{{ trans('admin.Reports.reports.financial.table.title') }}</div>
            <table>
                <thead>
                    <tr>
                        <th>#</th>
    ...
    @if ($chartData)
        <script>
            ...
            const revenueTrendOptions = {
                ...
                series: [{
                    name: '{{ trans('admin.Reports.reports.financial.charts.charges') }}',
                    data: @json($chartData['revenueTrend']['charges'])
                }, {
                    name: '{{ trans('admin.Reports.reports.financial.charts.payments') }}',
                    data: @json($chartData['revenueTrend']['payments'])
                }, {
                    name: '{{ trans('admin.Reports.reports.financial.charts.outstanding') }}',
