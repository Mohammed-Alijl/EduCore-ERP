    <script>
        $(function() {
            ...
            const table = $('#outstanding_balances_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.Reports.reports.financial.outstanding-balances') }}',
                    type: 'GET',
            ...
            const studentDistributionOptions = {
                    ...
                    pie: {
                        ...
                        donut: {
                            ...
                            labels: {
                                ...
                                total: {
                                    show: true,
                                    label: '{{ trans('admin.Reports.reports.financial.charts.total_students') }}',
                                    fontSize: '13px',
                                    fontWeight: 500,
                ...
                tooltip: {
                    ...
                    y: {
                        formatter: function(val) {
                            return val + ' {{ trans('admin.Reports.reports.financial.charts.students') }}';
                        }
                    }
                },
                dataLabels: {
