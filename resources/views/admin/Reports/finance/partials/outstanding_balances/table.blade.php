                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div>
                            <h3 class="section-title mb-0">
                                {{ trans('admin.Reports.reports.financial.table.title') }}
                            </h3>
                            <p class="section-subtitle mb-0">
                                {{ trans('admin.Reports.reports.financial.table.subtitle') }}
                            </p>
                        </div>
                        <div class="mt-3 mt-md-0 d-flex gap-2">
                            ...
                            <span class="badge badge-primary"
                                ...
                                {{ trans('admin.Reports.reports.financial.table.records') }}
                            </span>
                        </div>
                    </div>
                </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p">
                                        ...
                                        {{ trans('admin.Reports.reports.financial.table.student_name') }}
                                    </th>
                                    <th class="wd-15p">
                                        <i class="las la-receipt mr-1 ml-1"></i>
                                        {{ trans('admin.Reports.reports.financial.table.total_charges') }}
                                    </th>
                                    <th class="wd-15p">
                                        <i class="las la-money-bill-wave mr-1 ml-1"></i>
                                        {{ trans('admin.Reports.reports.financial.table.total_payments') }}
                                    </th>
                                    <th class="wd-15p">
                                        <i class="las la-exclamation-triangle mr-1 ml-1"></i>
                                        {{ trans('admin.Reports.reports.financial.table.net_balance') }}
                                    </th>
                                    <th class="wd-15p">
                                        <i class="las la-calendar-check mr-1 ml-1"></i>
                                        {{ trans('admin.Reports.reports.financial.table.last_payment') }}
                                    </th>
