                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1">
                            <div class="kpi-label">
                                {{ trans('admin.Reports.reports.financial.kpis.total_outstanding') }}
                            </div>
                            ...
                            <div class="mt-3 d-flex align-items-center">
                                ...
                                <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                    {{ trans('admin.Reports.reports.financial.kpis.currency') }}
                                </span>
                            </div>
                        </div>
            ...
            <div class="kpi-card primary">
                <div class="card-body p-4">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1">
                            <div class="kpi-label">
                                {{ trans('admin.Reports.reports.financial.kpis.students_count') }}
                            </div>
                            ...
                            <div class="mt-3 d-flex align-items-center">
                                ...
                                <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                    {{ trans('admin.Reports.reports.financial.kpis.active_students') }}
                                </span>
                            </div>
                        </div>
                        <div class="kpi-icon-wrapper">
            ...
            <div class="kpi-card success">
                <div class="card-body p-4">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-grow-1">
                            <div class="kpi-label">
                                {{ trans('admin.Reports.reports.financial.kpis.average_debt') }}
                            </div>
                            ...
                            <div class="mt-3 d-flex align-items-center">
                                ...
                                <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                    {{ trans('admin.Reports.reports.financial.kpis.per_student') }}
                                </span>
                            </div>
                        </div>
                        <div class="kpi-icon-wrapper">
