                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h3 class="grades-section-title mb-0">
                            {{ trans('admin.Reports.reports.grades.table.title') }}
                        </h3>
                        <p class="grades-section-subtitle mb-0">
                            {{ trans('admin.Reports.reports.grades.table.subtitle') }}
                        </p>
                    </div>
                    <div class="mt-3 mt-md-0">
                        <span class="badge badge-primary"
                            ...
                            {{ trans('admin.Reports.reports.grades.table.records') }}
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    ...
                                    {{ trans('admin.Reports.reports.grades.table.student_name') }}
                                </th>
                                <th>
                                    <i class="las la-layer-group mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.grade') }}
                                </th>
                                <th>
                                    <i class="las la-school mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.classroom') }}
                                </th>
                                <th>
                                    <i class="las la-book mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.subject') }}
                                </th>
                                <th>
                                    <i class="las la-file-alt mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.exam') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-star mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.score') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-percentage mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.percentage') }}
                                </th>
                                <th class="text-center">
                                    <i class="las la-check-circle mr-1 ml-1"></i>
                                    {{ trans('admin.Reports.reports.grades.table.status') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
