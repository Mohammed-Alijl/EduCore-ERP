                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="grades-kpi-label">
                            {{ trans('admin.Reports.reports.grades.kpis.total_students') }}
                        </div>
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.Reports.reports.grades.kpis.unique_students') }}
                            </span>
                        </div>
                    </div>
        ...
        <div class="grades-kpi-card emerald">
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="grades-kpi-label">
                            {{ trans('admin.Reports.reports.grades.kpis.average_score') }}
                        </div>
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.Reports.reports.grades.kpis.overall_avg') }}
                            </span>
                        </div>
                    </div>
                    <div class="grades-kpi-icon-wrapper">
        ...
        <div class="grades-kpi-card amber">
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="grades-kpi-label">
                            {{ trans('admin.Reports.reports.grades.kpis.pass_rate') }}
                        </div>
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.Reports.reports.grades.kpis.passing_threshold') }}
                            </span>
                        </div>
                    </div>
                    <div class="grades-kpi-icon-wrapper">
        ...
        <div class="grades-kpi-card purple">
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div class="flex-grow-1">
                        <div class="grades-kpi-label">
                            {{ trans('admin.Reports.reports.grades.kpis.total_exams') }}
                        </div>
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            ...
                            <span class="ml-2 mr-2" style="font-size: 0.8125rem; font-weight: 600; color: #6c757d;">
                                {{ trans('admin.Reports.reports.grades.kpis.exams_with_results') }}
                            </span>
                        </div>
                    </div>
                    <div class="grades-kpi-icon-wrapper">
