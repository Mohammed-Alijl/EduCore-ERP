...
<script>
    $(function() {
        ...
        const scoreDistChart = new ApexCharts(document.querySelector('#score-distribution-chart'), {
            series: [{
                name: @json(trans('admin.Reports.reports.grades.charts.students_count')),
            ...
            yaxis: {
                title: {
                    text: @json(trans('admin.Reports.reports.grades.charts.students_count')),
                    style: {
                        fontWeight: 700
                    }
                }
        ...
        const subjectChart = new ApexCharts(document.querySelector('#subject-performance-chart'), {
            series: [{
                name: @json(trans('admin.Reports.reports.grades.charts.average_score')),
            ...
            xaxis: {
                max: 100,
                title: {
                    text: @json(trans('admin.Reports.reports.grades.charts.average_score')),
                    style: {
                        fontWeight: 700
                    }
                },
        ...
        const gradeChart = new ApexCharts(document.querySelector('#grade-comparison-chart'), {
            series: [{
                ...
                name: @json(trans('admin.Reports.reports.grades.charts.pass_rate')),
        ...
        const gradesTable = $('#grades_report_table').DataTable(getTableConfig({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('admin.Reports.reports.grades.index') }}',
                data: function(d) {
        ...
        $('#grades-filter-form').on('submit', function(e) {
            ...
            const url = '{{ route('admin.Reports.reports.grades.index') }}' + (queryString ? '?' + queryString :
                '');
        ...
        $('#btn-reset-filters').on('click', function() {
            window.location.href = '{{ route('admin.Reports.reports.grades.index') }}';
        });
        ...
        function loadSubjects() {
            ...
            $.ajax({
                url: '{{ route('admin.Reports.reports.grades.subjects') }}',
                type: 'GET',
                data: {
                    grade_id: gradeId,
                ...
                success: function(response) {
                    if (response.success) {
                        subjectSelect.empty().append(
                            '<option value="">{{ trans('admin.Reports.reports.grades.filters.all_subjects') }}</option>'
                        );
        ...
        function loadExams() {
            ...
            $.ajax({
                url: '{{ route('admin.Reports.reports.grades.exams') }}',
                type: 'GET',
                data: {
        ...
        $('#filter-grade').on('change', function() {
            ...
            classroomSelect.html(
                '<option value="">{{ trans('admin.Reports.reports.grades.filters.select_classroom') }}</option>'
            );
            sectionSelect.html(
                '<option value="">{{ trans('admin.Reports.reports.grades.filters.select_section') }}</option>'
            );
