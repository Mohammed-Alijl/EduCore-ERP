...
<head>
    ...
    <title>{{ trans('admin.Reports.reports.attendance.title', [], $locale) }}</title>
    ...
    <div class="report-container">
            ...
            <div class="header-content">
                <div class="school-info">
                    ...
                    <div>
                        ...
                        <div class="report-title">{{ trans('admin.Reports.reports.attendance.title', [], $locale) }}</div>
                    </div>
                </div>
                <div class="report-meta">
                    ...
                    <div class="report-meta-item">
                        <span>{{ trans('admin.Reports.reports.attendance.table.records', [], $locale) }}:</span>
        ...
        <div class="stats-row">
            <div class="stat-card">
                ...
                <div class="stat-label">{{ trans('admin.Reports.reports.attendance.table.records', [], $locale) }}</div>
            </div>
            <div class="stat-card success">
                <div class="stat-value">{{ $avgAttendance }}%</div>
                <div class="stat-label">{{ trans('admin.Reports.reports.attendance.kpis.average_attendance', [], $locale) }}
                </div>
            </div>
            <div class="stat-card success">
            ...
            <div class="stat-card danger">
                ...
                <div class="stat-label">{{ trans('admin.Reports.reports.attendance.kpis.at_risk', [], $locale) }}</div>
            </div>
        </div>
        ...
        @if ($chartData)
            <div class="charts-section">
                ...
                <div class="chart-card">
                    <div class="chart-title">{{ trans('admin.Reports.reports.attendance.charts.absences_by_day', [], $locale) }}</div>
                    <div id="absencesByDayChart" class="chart-container"></div>
                </div>

                {{-- Attendance Distribution --}}
                <div class="chart-card">
                    <div class="chart-title">{{ trans('admin.Reports.reports.attendance.charts.distribution', [], $locale) }}</div>
                    <div id="distributionChart" class="chart-container"></div>
                </div>

                {{-- Absences by Grade --}}
                <div class="chart-card">
                    <div class="chart-title">{{ trans('admin.Reports.reports.attendance.charts.absences_by_grade', [], $locale) }}</div>
        ...
        <div class="table-section">
            <div class="table-header">
                <h3 class="table-title">{{ trans('admin.Reports.reports.attendance.table.subtitle', [], $locale) }}</h3>
                <p class="table-subtitle">{{ $records->count() }}
                    {{ trans('admin.Reports.reports.attendance.table.records', [], $locale) }}</p>
            </div>
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('admin.Reports.reports.attendance.table.student_name', [], $locale) }}</th>
                        <th>{{ trans('admin.Reports.reports.attendance.table.section', [], $locale) }}</th>
                        <th class="text-center">{{ trans('admin.Reports.reports.attendance.table.total_days', [], $locale) }}
                        </th>
                        <th class="text-center">{{ trans('admin.Reports.reports.attendance.table.present', [], $locale) }}</th>
                        <th class="text-center">{{ trans('admin.Reports.reports.attendance.table.absent', [], $locale) }}</th>
                        <th class="text-center">{{ trans('admin.Reports.reports.attendance.table.late', [], $locale) }}</th>
                        <th class="text-center" style="width: 100px;">
                            {{ trans('admin.Reports.reports.attendance.table.percentage', [], $locale) }}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center" style="padding: 40px;">
                                {{ trans('admin.Reports.reports.attendance.charts.no_data', [], $locale) }}
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <div class="report-footer">
            <div class="footer-note">
                {{ trans('admin.HR.attendances.print_footer', [], $locale) }}
            </div>
            <div class="footer-note">
    ...
    @if ($chartData)
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Translation labels
                const labels = {
                    excellent: '{{ trans('admin.Reports.reports.attendance.charts.excellent', [], $locale) }}',
                    good: '{{ trans('admin.Reports.reports.attendance.charts.good', [], $locale) }}',
                    warning: '{{ trans('admin.Reports.reports.attendance.charts.warning', [], $locale) }}',
                    critical: '{{ trans('admin.Reports.reports.attendance.charts.critical', [], $locale) }}',
                    absences: '{{ trans('admin.Reports.reports.attendance.charts.absences', [], $locale) }}',
                };
                        ...
                        pie: {
                            donut: {
                                ...
                                labels: {
                                    ...
                                    total: {
                                        show: true,
                                        label: '{{ trans('admin.Reports.reports.attendance.table.records', [], $locale) }}',
                                        fontSize: '12px',
                                        fontWeight: 600
                                    }
                                }
