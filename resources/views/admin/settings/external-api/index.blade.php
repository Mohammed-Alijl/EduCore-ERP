...
@section('title', __('admin.external_api.title'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('admin.external_api.title') }}</span>
            </div>
        </div>
    </div>
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-api').on('click', function() {
                ...
                const fieldLabels = {
                    'domain': "{{ __('admin.external_api.mailgun.domain') }}",
                    'secret': "{{ __('admin.external_api.mailgun.secret') }}",
                    'endpoint': "{{ __('admin.external_api.mailgun.endpoint') }}",
                    'client_id': "{{ __('admin.external_api.zoom.client_id') }}",
                    'client_secret': "{{ __('admin.external_api.zoom.client_secret') }}",
                    'account_id': "{{ __('admin.external_api.zoom.account_id') }}",
                    'api_key': "{{ __('admin.external_api.firebase.api_key') }}",
                    'project_id': "{{ __('admin.external_api.firebase.project_id') }}",
                    'messaging_sender_id': "{{ __('admin.external_api.firebase.messaging_sender_id') }}",
                    'app_id': "{{ __('admin.external_api.firebase.app_id') }}",
                };
