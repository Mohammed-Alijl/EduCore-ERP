<header class="w-full sticky top-0 z-20 bg-slate-50/80 backdrop-blur-xl shadow-sm flex justify-between items-center px-4 md:px-6 h-16">
    ...
    <div class="flex items-center gap-2 md:gap-4">
        <div class="relative group hidden md:block">
            ...
            <input class="bg-surface-container-high border-none rounded-full pl-10 pr-4 py-1.5 text-sm w-48 lg:w-64 focus:ring-2 focus:ring-primary/40 transition-all" placeholder="Search school records..." type="text" />
        </div>
        <!-- Mobile Search -->
        <button class="md:hidden p-2 rounded-full hover:bg-slate-100/50 transition-colors relative">
